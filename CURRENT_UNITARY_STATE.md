...
2. what source commit GitHub Pages deployed;
3. what exact public content was independently read back;
...
transcription, English translation, proposition matrix and reciprocal links.
It distinguishes the officers' direct observations from statements recorded
from identified or unidentified interlocutors and from later party inference.
...
publication and exact readback before they can be called live-verified. The
204-ID, 194-ID and prior 185-ID readbacks remain historical deployment evidence.
Archive backfill remains open. Identity resolves identity
