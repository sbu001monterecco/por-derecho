...
- For every public receipt, filing screenshot, scan, PDF derivative or image, apply `.github/governance/PUBLIC_PERSONAL_DATA_REDACTION_RULE_19SEP2026.md`: never expose a private home/street/postal address; redact identity numbers, private email/phone, signatures and authentication/security material unless strictly necessary and expressly authorised. Keep the unredacted original in private evidence custody and review image pixels as well as parsed text before publication.
