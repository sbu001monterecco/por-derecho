...
Use four corpora:
- **A — Sixto privileged**
- **B — Carlos Llamas Sanz privileged**
- **C — shared counsel/client coordination**
- **D — external-safe primary evidence**

If a fact is first identified in privileged advice, locate the underlying court order/email/invoice/pagaré/registry record and use that independent source externally.

## Cuatrecasas leadership communication — current disclosure rule

The communication should make clear, without disclosing strategy, that existing proceedings do not exhaust the matter and further evidence-led steps are being prepared.

Safe formulation:

> “The existing La Laguna proceedings address only part of the relevant conduct and prejudice. Aweswell, LPB and Matkator continue to preserve all rights and are preparing further evidence-led steps before the competent forums. This communication is deliberately non-exhaustive and must not be treated as disclosure or waiver of the complete legal, evidential or procedural analysis.”

Do not identify the future cause of action, forum, defendants, timing, remedy or evidential sequence.

## DP 748/2026 disclosure gate

Do **not** automatically name DP 748/2026 in a Cuatrecasas leadership communication.

Before naming it, verify:
- latest signed procedural status;
- whether Cuatrecasas is already formally aware;
...
Disclosure options:
A. minimal express reference to `ETJ 163/2020` and `DP 748/2026`;
...
Some earlier conversation-only uploads have expired. Recover originals first from Gmail, Google Drive, File Library or GitHub. If still unavailable, mark **PRIMARY SOURCE REQUIRES RE-UPLOAD**. Do not replace a missing original with a prior AI summary.
