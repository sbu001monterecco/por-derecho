...
1. **stamped presentation evidence** — proves physical presentation/label/content shown on the face of the source;
2. **official ATLANTE/court records** — prove the fields actually displayed by the official source;
3. **contemporaneous correspondence** — proves what was being reported/understood at the time, but is not a substitute for a certified reparto/index;
4. **later court acts** — prove how the court later characterised DP 1901.

No source below, alone or in combination, proves intentional misrouting, improper joinder, prosecutorial misconduct, judicial prevarication or coordination.

## Hash-locked connected source set

The original images remain in connected private custody and are not committed publicly because the originals contain presentation/private-data fields. Their byte identities are fixed here.

| Date | Source | SHA-256 | What the visible source establishes | Limit |
|---|---|---|---|---|
| 18 Jun 2026 | stamped AC complaint cover, source filename `1000096476.jpg` | `c377ecb9a0a7a83c9b6b62ac6009affb27e26da61a33eb92d25b3b8c7bcd3b7d` | separate complaint concerning the Administrador Concursal; Decanato stamp 18 Jun; handwritten daily reference 22 | does not by itself prove later DP 1956 allocation |
| 18 Jun 2026 | stamped judge-complaint cover, source filename `1000096477.jpg` | `2f9b7015598094c68f6408b68a776073de1d7d2fa248169be46fd57bf3bad6c3` | separate complaint/notitia criminis concerning Alberto López Villarrubia; addressed to Sala Civil y Penal TSJC; Decanato stamp 18 Jun; handwritten daily reference 24 | does not prove TSJC receipt/admission or later DP allocation |
| 25 Jun 2026 | stamped private-actor complaint cover, source filename `20260625_105537.jpg` | `8ee03884d32b6b3d9e8377a646eca3d79a7ae199aebc8cc378a9180ba2aef846` | autonomous complaint against five private actors; Decanato stamp 25 Jun; handwritten daily reference 21 | presentation reference is not a DP/NIG |
| 25 Jun 2026 | stamped dependent judge supplement, source filename `20260625_105552.jpg` | `724caf532c25159ead6ae4cfd88c21acbc2d1f202e2bc08cfd713ad07c0376f1` | 13-page “APORTACIÓN COMPLEMENTARIA AUTOSUFICIENTE — CONTROL 24”; expressly requests joinder to the 18-Jun daily-reference-24 judge complaint and states autonomy from the other complaint lane | proves intended joinder, not that Decanato/court electronically effected it |
| 9 Jul 2026 | ATLANTE “Listado de certificaciones para información al ciudadano”, source filename `Atlantes GM 9JUL2026.jpeg` | `af51c3fd744eae415a5818543e996f656709552b3b3c1c0750c31f7403274042` | Gil Marer shown as denunciante in DP 1901/2026, Plaza 6, and DP 1956/2026, Plaza 1 | ATLANTE image does **not** identify defendants/subject matter |
| 9 Jul 2026 | stamped private-actor amplification cover, source filename `Ampliacion Proc.1901-2026 (CAM et al) 09JUL2026.jpeg` | `dfad6f405b7a2ec047a98a7183a9cbfd0698427d3925d02b2a50b4de76de8f71` | Decanato-stamped 9-Jul filing expressly identifies Plaza 6, Diligencias Previas 1901/2026, and an amplification/documentary contribution | proves tender under DP 1901, not electronic incorporation, judicial reading or proper original allocation |

## Chronology that materially narrows the collision

### 18 June — two different complaint packages existed from inception

The two stamped presentation covers establish separate packages:
- daily reference **22**: Administrador Concursal complaint;
- daily reference **24**: judge/judicial-conduct complaint addressed to the TSJC Civil/Criminal Chamber and expressly framed as denuncia/notitia criminis.

This excludes any reconstruction in which references 22 and 24 were merely alternate labels for one filing.

### 25 June — a third autonomous complaint was filed, while the judge supplement remained separately identified

The stamped private-actor cover establishes a new autonomous five-private-actor filing under daily reference **21**.
...
The ATLANTE image officially displays:
- DP 1901/2026 — Plaza 6 — Gil Marer as denunciante;
- DP 1956/2026 — Plaza 1 — Gil Marer as denunciante.

The ATLANTE image itself does not label either proceeding by defendant or subject.

Separately, the stamped 9-Jul cover proves that an amplification/documentary contribution concerning the private-actor lane was physically presented **for DP 1901/2026, Plaza 6**.

Contemporaneous correspondence to the procuradora and counsel describes the operational understanding at that time as:
...
The 14-Sep Auto states that DP 1901 was opened on Gil Marer's complaint for alleged prevaricación, records a 29-Jul Fiscal report seeking archive, and orders sobreseimiento libre/archive.

## What is now materially stronger

The source set now supports all of the following without relying on hindsight:
...
3. complete certified DP 1901 electronic docket/index;
4. ingestion/electronic-incorporation record for the 9-Jul private-actor amplification;
...
The 14-Sep Auto should not be allowed to acquire an ambiguous scope over an unidentified procedural corpus. Any response should place **objective identity/provenance of DP 1901 before merits**, and require an express determination of whether the Auto purports to affect any autonomous private-actor complaint.
