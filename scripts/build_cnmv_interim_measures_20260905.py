...
def validate(outputs):
    ...
    for path,text in outputs.items():
        ...
        if path.endswith('.html'):
            ...
            for bad in ['mail.google.com','sdmnt','ANGjd']:
