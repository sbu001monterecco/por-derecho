...
def spanish_story(styles):
    ...
    sources = [
        ...
        ("DIP 2/2026", "https://sbu001monterecco.github.io/por-derecho/es/fiscalia-dip-2-2026/", "Archivo y error documental sobre estado de apelación."),
...
def english_story(styles):
    ...
    sources = [
        ...
        ("DIP 2/2026", "https://sbu001monterecco.github.io/por-derecho/en/fiscalia-dip-2-2026/", "Archive and documented appeal-status error."),
