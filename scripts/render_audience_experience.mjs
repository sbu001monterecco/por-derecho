...
const routes = [
  { lang: 'es', route: '/es/', summary: '#resumen-60-segundos', perimeters: '#elegir-via', chronology: '#actores-privados', directText: 'Tres vías. Propósitos distintos. Límites claros.' },
  { lang: 'en', route: '/en/', summary: '#sixty-second-summary', perimeters: '#choose-route', chronology: '#private-actors', directText: 'Three paths. Different purposes. Clear boundaries.' },
];
const viewports = [
