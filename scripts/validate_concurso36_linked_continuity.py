...
en_page = require_markers(
    ...
    [
        ...
        "“Not located” means absent from the controlled corpus; it does not establish nonexistence, loss, suppression or alteration.",
...
es_page = require_markers(
    ...
    [
        ...
        "«No localizado» significa ausente del corpus controlado; no demuestra inexistencia, pérdida, supresión ni alteración.",
