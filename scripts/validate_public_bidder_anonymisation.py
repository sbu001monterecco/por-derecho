...
LOCAL_REQUIRED_MARKERS: dict[str, tuple[str, ...]] = {
    "es/adjudicacion-2022-reconstruccion-documental/index.html": (
        ...
        "Auto 164/2021",
        "incomparecencia",
        "falta de constitución de la caución",
        "la licitación competitiva no podía tener lugar",
        "aprueba definitivamente la propuesta de CAM",
    ),
    "en/2022-adjudication-documentary-reconstruction/index.html": (
        ...
        "the competitive licitation could not take place",
        "definitively approves CAM's proposal",
    ),
    "es/correcciones-control-versiones/index.html": (
        ...
        "incomparecencia y falta de caución",
        "la licitación competitiva no podía tener lugar",
        "aprueba definitivamente CAM",
    ),
    "en/corrections-version-control/index.html": (
        ...
        "nonappearance and failure to lodge the bond",
        "the competitive licitation could not take place",
        "definitively approves CAM",
    ),
