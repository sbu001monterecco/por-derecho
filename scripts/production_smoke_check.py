...
CHECKS = [
    ...
    {"path": "en/cam-creditor-control-shadow-administration-judicial-omission/",
     "markers": ["They are not judicial findings.", "DIRECT-INSTRUCTION ALLEGATION", "The 2018 provisional dismissal and appellate confirmation remain prominently preserved."],
    ...
    {"path": "es/control-acreedor-cam-administracion-hecho-omision-judicial/",
     "markers": ["No son declaraciones judiciales.", "ALEGACIÓN DE INSTRUCCIÓN DIRECTA", "Se conservan con igual visibilidad el archivo provisional de 2018 y su confirmación en apelación."],
