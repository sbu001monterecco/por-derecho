...
CHECKS = [
    ...
    {"path": "es/bernardo-del-rosal-frob-bankia-sun-rock/",
     "markers": ["Del Rosal / FROB–BFA–Bankia ↔ Sun Rock", "PRE_ENGAGEMENT_REVIEW", "LA LENTE COMÚN"],
     "kind": "del_rosal_overlap_es", "min_bytes": 12000},
    {"path": "en/bernardo-del-rosal-frob-bankia-sun-rock/",
