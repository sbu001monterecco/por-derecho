...
CHECKS = [
    ...
    {"path": "es/cajasiete-responsabilidad-cumplimiento-trazabilidad/",
     "markers": ["Una parte directamente afectada. Una persona informante desde 2021.", "2021002141", "Cinco preguntas finitas para una respuesta institucional"],
     "kind": "cajasiete_institutional_reader_es", "min_bytes": 30000},
    {"path": "en/cajasiete-accountability-compliance-traceability/",
     "markers": ["A directly affected party. A reporting person since 2021.", "2021002141", "Five finite questions for an institutional response"],
     "kind": "cajasiete_institutional_reader_en", "min_bytes": 30000},
    {"path": "es/cajasiete-responsabilidad-cumplimiento-trazabilidad/snapshots/2026-09-18-1716/",
     "markers": ["PD-CAJASIETE-ACCOUNTABILITY-20260918", "NO PEDIMOS CONFESIONES. PEDIMOS EXPEDIENTES."],
     "kind": "cajasiete_sent_snapshot_es", "min_bytes": 25000},
    {"path": "en/cajasiete-accountability-compliance-traceability/snapshots/2026-09-18-1716/",
     "markers": ["PD-CAJASIETE-ACCOUNTABILITY-20260918", "WE ARE NOT ASKING FOR CONFESSIONS. WE ARE ASKING FOR THE FILES."],
     "kind": "cajasiete_sent_snapshot_en", "min_bytes": 25000},
    {"path": "es/cajasiete-sun-park-financiacion-comparabilidad/",
     "markers": ["Dos carriles, una separación obligatoria", "cajasiete-responsabilidad-cumplimiento-trazabilidad"],
     "kind": "cajasiete_commercial_lane_es", "min_bytes": 15000},
    {"path": "en/cajasiete-sun-park-financing-comparability/",
     "markers": ["Two lanes, one mandatory separation", "cajasiete-accountability-compliance-traceability"],
     "kind": "cajasiete_commercial_lane_en", "min_bytes": 15000},
    ...
    {"path": "de/lava-verde-club-sei-meeting-point/",
     "markers": ["Lava Verde, Club Sei Lanzarote und die offene Recovery-Frage.", "fast 980 Mio. EUR"],
     "kind": "sent_email_lava_verde_canonical_de", "min_bytes": 15000},
    ...
    {"path": "es/concurso-36-2012-que-ordeno-el-juzgado/",
     "markers": ["Concurso 36/2012 — qué ordenó el Juzgado y por qué la vía importa", "Incidentes concursales primarios actualmente localizados"],
     "kind": "concurso36_orders_reader_es", "min_bytes": 13000},
    {"path": "en/concurso-36-2012-what-the-court-ordered/",
     "markers": ["Insolvency 36/2012 — what the Court ordered and why the route matters", "Primary insolvency incidents currently located"],
     "kind": "concurso36_orders_reader_en", "min_bytes": 13000},
    ...
    {"path": "en/ph122-cerberus-haya-bankia-external-perimeter/",
     "markers": ["The correspondence evidences an evaluation channel; it does not itself identify the decision-maker", "Promontoria Holding 122 B.V. / PH122"],
     "kind": "ph122_perimeter_en", "min_bytes": 5000},
    {"path": "es/perimetro-ph122-cerberus-haya-bankia-externo/",
     "markers": ["La correspondencia acredita un canal de evaluación; no identifica por sí sola al decisor", "Promontoria Holding 122 B.V. / PH122"],
