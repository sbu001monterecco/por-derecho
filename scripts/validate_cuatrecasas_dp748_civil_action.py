...
COMPARATOR_ROUTES = {
    "en/cuatrecasas-edgeworth-comparator/index.html": (
        ...
        "Exploratory comparison is not an alliance",
        "does <strong>not</strong> establish an executed claimant-to-claimant",
        ...
        "parallel questions, independent proof",
    ),
    "es/comparador-cuatrecasas-edgeworth/index.html": (
        ...
        "Una comparación exploratoria no es una alianza",
        "<strong>no</strong> acredita un acuerdo ejecutado entre demandantes",
        ...
        "preguntas paralelas, prueba independiente",
    ),
}
