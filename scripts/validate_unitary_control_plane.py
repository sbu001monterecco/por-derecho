...
def main() -> int:
    try:
        ...
        es_identity = require_markers(
            ...
            [
                'content="Registro operativo de 231 IDs inmutables',
                'data-static-registry-counts="231-95-79-11-23-23"',
                'data-registry-stat="TOTAL">231',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
                '"name":"Total","value":231',
        ...
        en_identity = require_markers(
            ...
            [
                'content="Operational Por Derecho register of 231 immutable IDs',
                'data-static-registry-counts="231-95-79-11-23-23"',
                'data-registry-stat="TOTAL">231',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
    ...
    print(" - source/static identity denominator: 231 / 95 / 79 / 11 / 23 / 23")
