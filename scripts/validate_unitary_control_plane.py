...
def main() -> int:
    try:
        ...
        es_identity = require_markers(
            ...
            [
                'content="Registro operativo de 227 IDs inmutables',
                'data-static-registry-counts="227-95-79-11-22-20"',
                'data-registry-stat="TOTAL">227',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
                '"name":"Total","value":227',
        ...
        en_identity = require_markers(
            ...
            [
                'content="Operational Por Derecho register of 227 immutable IDs',
                'data-static-registry-counts="227-95-79-11-22-20"',
                'data-registry-stat="TOTAL">227',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
    ...
    print(" - source/static identity denominator: 227 / 95 / 79 / 11 / 22 / 20")
