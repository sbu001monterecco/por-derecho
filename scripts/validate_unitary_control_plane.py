...
def main() -> int:
    try:
        ...
        es_identity = require_markers(
            ...
            [
                'content="Registro operativo de 230 IDs inmutables',
                'data-static-registry-counts="230-95-79-11-23-22"',
                'data-registry-stat="TOTAL">230',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
                '"name":"Total","value":230',
        ...
        en_identity = require_markers(
            ...
            [
                'content="Operational Por Derecho register of 230 immutable IDs',
                'data-static-registry-counts="230-95-79-11-23-22"',
                'data-registry-stat="TOTAL">230',
                'data-registry-stat="PERSON">95',
                'data-registry-stat="ORGANISATION">79',
    ...
    print(" - source/static identity denominator: 230 / 95 / 79 / 11 / 23 / 22")
