...
PAGES = [
    ...
    ROOT / 'en/public-prosecution-service/index.html',
    ROOT / 'es/ministerio-fiscal/oficinas/index.html',
    ROOT / 'en/public-prosecution-service/offices/index.html',
]
...
def main():
    ...
    missing_master = sorted(set(master_ids) - master_register_ids)
    require(not missing_master, f'directory Master_ID missing from master register: {missing_master}')
