...
RICH = {
    ...
    "P03": {
        ...
        "contrary_record": bi("The located criminal route ended in provisional archive and Auto 804/2018; the AC/CEXP record contains a contrary position, and the main witness did not place José Daniel Acosta Matos on site.", "La vía penal localizada terminó en sobreseimiento provisional y Auto 804/2018; el registro AC/CEXP contiene una posición contraria y el testigo principal no situó a José Daniel Acosta Matos en el lugar."),
