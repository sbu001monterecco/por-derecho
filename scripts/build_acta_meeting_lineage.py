...
UNITARY_ROUTE_ES = "es/ingenieria-inversa-criminal-unitaria/"
UNITARY_ROUTE_EN = "en/unitary-criminal-reverse-engineering/"
AUTHORITY_ROUTE_ES = "es/actas-comunidad-autoridades-publicas/"
AUTHORITY_ROUTE_EN = "en/community-actas-public-authorities/"
...
def lph_control_page(
    ...
    unitary_route = UNITARY_ROUTE_ES if es else UNITARY_ROUTE_EN
    authority_route = AUTHORITY_ROUTE_ES if es else AUTHORITY_ROUTE_EN
