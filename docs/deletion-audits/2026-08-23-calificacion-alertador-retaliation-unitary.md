...
- the Sixth Additional Provision correction, without retroactively turning earlier facts into later-law infringements;
...
The publication may state the party's strong allegation that the accusation package was materially overbroad, maliciously instrumentalised and structurally beneficial to the Acosta Matos perimeter. It must not state retaliation, malicious purpose, crime, concert, capture, personal judicial knowledge or criminal/civil/disciplinary liability as an adjudicated fact. It must keep adverse first-instance findings and independent explanations visible.
...
## Highest remaining evidence gaps

1. Certified 25-Jul-2023 hearing audiovisual/transcript/appearance and ruling record.
2. Certified complete RPL 2523/2025 docket, current decision and service/finality state.
3. Complete 918/2021 docket treatment and actor-specific judicial knowledge chain.
...
The continuation is preserved in `archive/CALIFICACION_CRIMINAL_FIRST_ELECONOMISTA_PLEADING_COVERAGE_REVERSE_ENGINEERING_24AUG2026.md`, the 24-Aug revision of `archive/prompts/CALIFICACION_ALERTADOR_RETALIATION_UNITARY_EXECUTION_PROMPT_23AUG2026.md`, and `ME-CAL-RET-018`–`023` / `CR-CAL-RET-013`–`017`.

It adds:

- criminal-first offence-neutral analysis without delaying civil preservation/limitation work;
- the exact Sentencia-not-Auto, LPB-not-whole-Sun-Park and not-dispositive-of-the-wider-pitch correction;
- separate Madrid DP 913/2025 treatment;
- named pleading-publication denominators and the exact `50/50`, `25/25`, `7/7`, updated `5/6` source-copy and `0/6` public-full-text states;
