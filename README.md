...
The judicial-spine routes now link to a controlled 2016–2021 court-file baseline: 65 located docket items plus one connected external complaint, kept outside the Mercantile docket count. The public evidence layer includes bilingual item-by-item digests, a reviewed redacted OCR derivative of the April-2017 convenio proposal and a public-safe digest of the newly located 37-page Article 75 report dated 15 January 2013. A bounded denominator refresh also located 105 LexNET provider-package filenames for document-level reconciliation; package count is not docket count. The corpus remains explicitly partial until the certified court/LAJ chronology is recovered and reconciled in both directions.
