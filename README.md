...
- `/es/tesis-uso-criminal-procedimiento-calificacion/` and `/en/insolvency-classification-criminal-misuse-thesis/` — canonical five-pillar, actor-specific investigative thesis for the Calificación record, with a bilingual Position/Objectives layer, the controlling transfer-of-value/responsibility-inversion/scrutiny-diversion hypothesis, finite proof demands, a controlled RPL 2523/2025 status card, an express appeal firewall, contrary evidence and equal-visibility right of reply
- `/es/calificacion-rpl-2523-mapa-prueba/` and `/en/calificacion-rpl-2523-evidence-map/` — proposition- and instrument-level map separating three first-instance oppositions, three located/reported appeals for four appellant interests, evidential states, finite certification gaps, five criminal-misuse proof tests and related context kept outside the RPL record lane
...
- `/es/cuatrecasas-dp748-accion-civil/` and `/en/cuatrecasas-dp748-civil-action/` — bilingual, privacy-controlled position separating DP 748/2026, the La Laguna enforcement/assignee hypothesis and the planned Spain-led civil audit; it includes a document-answerable institutional accountability protocol, states that no UK court action is being pursued and keeps any SRA question separate, non-litigation, secondary and jurisdiction-dependent
- `/es/comparador-cuatrecasas-edgeworth/` and `/en/cuatrecasas-edgeworth-comparator/` — bilingual professional-negligence comparator separating the public Edgeworth allegations, denial and procedural judgment from the independent Sun Rock/Aweswell proof chain; it maps partial issue overlap without asserting precedent, pattern, common representation, formal inter-claimant cooperation or a current Sun Rock/Aweswell UK legal route
- `/es/cuatrecasas-sun-park/` and `/en/cuatrecasas-sun-park/` — bilingual mandate, invoice, rescue-package, protection, handover and later-enforcement reconstruction; the 12 June 2018 Stoneweg/Varia offer stage is distinguished from transaction completion, and the Elaia/Lagune documents are presented as reciprocal components of one documented EUR 26m route
- `/es/continuidad-defensa-letrados/` and `/en/counsel-defence-continuity/` — canonical former-counsel and professional-ecosystem record, including the controlled analytical framework for institutional pressure, interference with independent professional relationships, strategic isolation and professional/commercial attrition; causation and intent remain actor/event-specific.
...
## Repository preservation and editing rules

Every later editor or automated agent must follow [`AGENTS.md`](AGENTS.md) and the machine-readable [`ops/REPOSITORY_PRESERVATION_CONTRACT.json`](ops/REPOSITORY_PRESERVATION_CONTRACT.json). They require work to begin from current `main`, prohibit unrecorded deletion or renaming of protected material, preserve bilingual and evidential boundaries, and lock the five-private-actor plus two-distinct-institutional-role presentation on both homepages, fourteen canonical direct routes and the preserved Spanish legacy judicial route unless Gil Marer gives specific express authorization.

The exact repair/deployment evidence is retained in [`publication-manifests/five-actor-accountability-preservation-20260824.json`](publication-manifests/five-actor-accountability-preservation-20260824.json). Remaining reader-journey, route-discovery, dossier and backup work is assigned—not left in chat—in [`ops/FIVE_ACTOR_PRESERVATION_AND_READER_JOURNEY_BACKLOG.md`](ops/FIVE_ACTOR_PRESERVATION_AND_READER_JOURNEY_BACKLOG.md).

The AC professional-isolation/attrition module is controlled by `.github/governance/AC_PROFESSIONAL_ISOLATION_ATTRITION_PROTOCOL_22SEP2026.md` (`PD-GOV-AC-PIA-20260922-01`), `archive/AC_PROFESSIONAL_ISOLATION_ATTRITION_CANON_22SEP2026.md` and `assets/data/ac-professional-isolation-attrition-v1.json`. It replaces non-institutional character labels with a testable mechanism framework, preserves four separate professional/commercial rings, requires contrary evidence and lawful alternatives, and prohibits automatic causation from payment, contact, withdrawal, procedural exposure or later outcomes.

The preservation gate is additive: summaries, redesigns and new reader journeys may strengthen the first read, but they do not replace the complete record. Git history preserves earlier source; CI must also prevent live routes, assets, actor distinctions, contrary evidence and linkage from silently disappearing from the current tree or rendered site.
...
The Cuatrecasas DP 748/civil-action pages must not publish the names of current lawyers or procedural representatives. They preserve principal responsibility allegations against the Acosta Matos perimeter and treat any Cuatrecasas responsibility as separate and potentially cumulative. A connected remate recipient is a client-side leading hypothesis to be tested through court, KYC/AML, funding and beneficial-ownership records; no assignee identity is published as fact without primary proof. Institutional pressure is applied through precise record requests, preservation, right of reply and competent Spain-led routes. Silence is recorded only as unanswered, never as proof; privileged strategy, personal targeting and unsupported criminal conclusions are prohibited.

All later Cuatrecasas billing/email work is controlled by `archive/CUATRECASAS_PERIMETER_BILLING_EMAIL_AGENTIC_CONTINUATION_24AUG2026.md`. It requires a 2014-to-present whole-perimeter audit, line-level invoice-to-deliverable-to-result reconciliation, complete email/attachment searching and strict separation of client, beneficiary, payer, pagaré issuer and judicial debtor. Private timekeeper/disbursement ledgers, unredacted emails and unsent correspondence remain outside the public repository. Campaign research and drafting may resume when the synchronized pages are live, but nothing may be sent without a fresh final authorization covering the exact recipients, text, links and attachments.

The Edgeworth comparator is controlled by `archive/CUATRECASAS_EDGEWORTH_PARTIAL_OVERLAP_CONTROL_24AUG2026.md`. It may compare issue families, procedure and communication discipline, but must keep parties, legal entities, retainers, transactions, evidence, disclosure duties, causation, quantum and remedies separate. The 2 May 2025 judgment is procedural and contains no professional-negligence merits finding. Sun Rock/Aweswell is not pursuing UK legal proceedings and no UK firm is currently instructed for such proceedings. Private synergy material remains outside the public corpus; exploratory comparison must not be described as claimant-to-claimant alliance, joint representation, shared privilege, common-interest agreement, evidence-use authority or coordinated witness/media/settlement strategy.

Every future Cuatrecasas billing, collection, Risk, Compliance or professional-responsibility communication must apply `archive/CUATRECASAS_CROSS_BORDER_AFFECTED_REPORTING_PERSON_CONTROL_24AUG2026.md`: identify Aweswell Limited as the UK-incorporated holding company and foreign investor in Spain; preserve the cross-border UK/Spain service relationship; distinguish direct/indirect claimed injury from adjudicated loss; state Gil Marer's reporting-person/whistleblower position with its applicability safeguard; separate claim assignment, cession of remate, adjudication/later asset transfer and recovery-sharing routes; require one single-satisfaction account and lawful conflict/KYC certification; and require current-counsel review plus specific user authorisation before any dispatch or Ethics Channel submission.
...
Public-safe RICPE evidence analysis may be released when the Spanish and English versions are checked against the same source record and each proposition is clearly classified as documented fact, attributed allegation, inference or open question. Publication does not depend on prior delivery of a separate confidential communication. Any claim that RICPE received direct notice, acknowledged it, preserved records or failed to respond still requires a verifiable delivery/receipt record; the public response register must not infer guilt from silence.

Private witnesses, the raw audio, the full/working transcript, other privileged or confidential lawyer content, unnecessary personal data and live procedural strategy remain outside the repository. A short attributed phrase may be reproduced only when necessary to delimit the public allegation and accompanied by authentication and context limits. The public page may report controlled chronology and evidential metadata, but it must state the limits: no RICPE mandate to a third party is asserted without proof; pre-2023 conduct is not retroactively labelled under Law 2/2023; and no particular legal-advice or judicial outcome is attributed without contact, causation and counterfactual evidence. Any March 2021 allegation must distinguish the specific 26 May 2020 change of counsel for Aweswell's procedural representation in Concurso 36/2012 from any wider or residual professional relationship; it must not publish unnecessary fee history, describe that event as a firm-wide withdrawal or state that a later message completed a rupture. Any alleged later effect remains limited to a testable question concerning residual trust, confidentiality or assistance. Good-faith investors, prospective investors, advisers and public officials must not be described as complicit merely because they were exposed to a project or its marketing. Named persons and entities receive a finite, equally prominent right of reply and correction.
...
- `archive/THREAD_DELETION_AUDIT_PROFESSIONAL_FIRMS_REDIGEST_21AUG2026.md` — PwC / Grant Thornton / RSM / adverse-perimeter reverse-engineering, recipient separation, source-status and deletion-continuity control.
...
- `archive/THREAD_CONTINUITY_AUDIT_ANA_MARIA_CARLOS_LA_LAGUNA_20AUG2026.md` — Ana María / Carlos / La Laguna coordination gap, Carlos procedural architecture, and future-call guardrails.
