...
- Confirm allocation and response to REGAGE26e00072883405. The receipt proves submission only.
- Request authenticated copies or certified extracts of existing Cabildo-held entries, indexes and source acts for the three identifiers, within Cabildo’s custody and competence.
...
- Request certified copies or extracts of all existing entries and source acts for the three identifiers, plus Inspection Acts 027951/2012 and 35328/2016.
- Ask whether any entry made or effective in 2014 identified Montelanza, S.L.; CEXP H35997568; Monterecco/Pink B76564517; the Owners’ Community H76013184; another entity; or no entity, and in what recorded capacity.
- Ask that an absence be reported from the register rather than inferred from a brand or trade name. If a formal negative certificate is unavailable, request a signed statement recording the defined search and its result.

### Ayuntamiento de Yaiza

- Keep the municipal inquiry separate from the tourism-register inquiry; Yaiza should not be asked to decide who was the lawful tourism operator.
- For 7043/2022, 7059/2022, 10356/2022, 1748/2022 and 5854/2022, request the existing document index and authenticated copies of applications, declarations, powers, minutes, titles/consents, technical or legal reports, checklists and decisions.
- Ask for documents showing whether and in what capacity each entity was identified by the declarant or municipality, which properties were specified and what verification was recorded.
- If a specified document is not held in a named file, request a formal certificate or signed statement of that limited absence after a defined search.
- Preserve the pending Comisionado appeal as a separate procedural track.

### Controlling formulation

Among the materials reviewed to date, CEXP is the only entity for which both a participating-owner collective resolution and a direct transfer from Montelanza, S.L. have been located. That is documentary provenance, not a finding of lawful exclusivity, universal mandate, registry status or uninterrupted operation. A signed 1 February 2012 CEXP–Monterecco notice purports to transfer the activity and names Monterecco as new operator; competent-body authority and complete scope remain unproved in the reviewed record. A 4 June 2014 party filing asked Cabildo to record the Owners’ Community—not CEXP—as succeeding Monterecco. Receipt does not prove acceptance or amendment. The authorities are asked only to identify what their existing records contain and what a defined search does not locate.
