# CAIXABANK VALENCIA — PUBLIC PAGE / LENDER-CHAIN CONTROL

**Date:** 16 August 2026  
**Status:** `CONTROLLING PUBLICATION / ROUTING SUPPLEMENT`

## Purpose

This control records the dedicated bilingual public page for the live Valencia banking claim and its required relationship to the Lender of Record / lender-in-possession chain.
...
- links from those generic pages may use the neutral label “Valencia banking claim” so the general page does not collapse historical and current banking identities; and
- older blanket language that the current defendant must never be named anywhere on the public website is superseded **to this dedicated-page extent**.

This is a publication-scope correction, not a change to historical creditor identity.

## 3. Current controlled case node
...
CaixaBank's 18-Jun-2024 expert report records pleaded prejudice of **€1,124,445.84**:

- €573,591.53;
- €63,882.93;
- €81,971.38;
- €405,000 pledged deposit.

This is a pleaded and contested recovery claim, not a recovered or adjudicated asset.

The bank expert's split between an allegedly AC-authorised component and an amount beyond that authorisation remains source-attributed to the bank expert until the native AC authorisation is independently controlled.
...
### Lane A — banking liability / recovery

The dedicated CaixaBank page tests the historic banking and financial-product relationship: loans/refinancing, swap or linked financial product, pledged deposit, account treatment, cure/default, acceleration, execution calculation and claimed loss.

### Lane B — later mortgage-credit / enforcement / possession / title

The connected chain tracks the later creditor and possession route through the historical Bankia perimeter, SAREB, Promontoria Holding 122 B.V., Construcciones Acosta Matos, adjudication/dación and later Hotel New Trend/title perimeter.
...
- 15-May-2012 Mortgage Execution 90/2012 auction schedule = **158 properties**;
- auction fixed 22-Jun-2012 10:00;
- 5-Mar-2012 bank correspondence distinguishes €940,737.53 global position from €54,653.80 cure amount;
- the June-2012 voluntary insolvency filing preceded the auction and had an immediate defensive function;
...
- native 2011 default/morosidad notice;
- full account ledgers and original financial instruments;
