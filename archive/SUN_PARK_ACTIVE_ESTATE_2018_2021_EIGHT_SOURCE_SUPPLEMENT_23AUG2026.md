...
1. signed 24-Oct-2019 non-convalidation Auto (complete source located; service/finality and implementation context still open);
2. 12-May-2020 Auto;
...
|---|---|---|---|---|
| `ME-PDFSCAN-001` | Preserve the located signed complete Auto of 24-Oct-2019; obtain signature-validation/authentication output, service record and any correction resolving the 23/24-Oct discrepancy. | Anchors non-convalidation while separating the located decision from its still-open service and implementation chain. | `C36-E029`, `ME-012`, `ME-061` | PARTIAL — COMPLETE SIGNED SOURCE LOCATED |
...
| `ME-PDFSCAN-003` | Preserve the located full AP Las Palmas Auto 78/2019 of 23-Jul-2019; obtain its finality certificate and the exact calculation record used for the third-bidder improvement condition. | Controls the res-judicata and interest proposition without re-requesting an already located decision. | `C36-E028`, `ME-011`, `ME-012` | PARTIAL — COMPLETE SIGNED SOURCE LOCATED |
