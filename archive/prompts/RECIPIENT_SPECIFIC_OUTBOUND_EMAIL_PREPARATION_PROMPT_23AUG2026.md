...
`earlier sent → reply / no reply → follow-up → acknowledgment / OOO / redirect / dispute → correction / supplement → current state`
...
- any ticket, case, expediente or thread reference;
- any OOO or alternative contact;
- any failed delivery;
- any correction that superseded earlier wording; and
...
- full name / office / role if known;
...
- RESPONSE TO INBOUND
- RE-ROUTING AFTER BOUNCE / OOO / REDIRECT
...
Spanish is normally the default for Spanish/Canary institutions, companies, professional bodies and journalists.

Use native professional phrasing rather than literal translation.

If multiple language versions are produced, run a parity check for:
...
1. personalised reason for contact;
2. concise explanation of the matter;
3. why it matters now / what changed;
4. three to five strongest evidential anchors;
5. appropriate source-status wording;
6. recipient-specific question or ask;
7. relevant source access;
...
- What is the strongest reasonable response by the recipient or adverse party?
- Does any adverse judgment or procedural outcome need to be disclosed or qualified?
- Is any assertion stronger than the repository evidence permits?
- Does the email imply that receipt equals examination?
...
- language;
- source/type;
- primary source vs explanatory derivative;
- evidence status;
- reason for inclusion;
- version/date;
- size if known; and
- whether it was previously supplied to the recipient.

Prefer recipient-matched ES/EN/DE visual versions.
...
- exact destination;
- category: WEBSITE HUB / SPECIFIC DOSSIER / PRIMARY PUBLIC SOURCE / VIDEO-WEBINAR / INSTITUTIONAL SOURCE;
- language;
- reason for inclusion;
- current verification result; and
- whether it was already supplied in the thread.
...
Where useful, create a Gmail draft with the final proposed To/Cc/Bcc, subject, body and approved-for-drafting attachments. Creation of a draft is not send authority.

After creating a draft, read it back and verify:
