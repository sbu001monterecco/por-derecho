# Prompt — exhaustive counsel / law-firm / defence-continuity scan

## Objective

Run an exhaustive, source-led scan of Gmail, Google Drive, Library and the Por Derecho repository for every lawyer, law firm, procurator and legal adviser who acted for Gil Marer, Luchy Playa Blanca, S.L.U. (LPB), Aweswell Limited, Matkator, Pink or the related Project-side perimeter in or around Concurso 36/2012.

Determine, person by person and mandate by mandate, whether an act or omission by the Insolvency Administrator affected defence, access to evidence, authority, payment, professional independence, continuity, substitution or withdrawal.

## Mandatory named starting set

Search exact names, accents, email-display variants, domains and firm variants for:

1. Juan Tomás Parrilla Suárez / jtparrilla;
2. Armando Betancor Álamo / José María Betancor Álamo / Davinia Sánchez de la Cruz / Alas Legal / Alas Legal Advisors / Kepler–Karst;
3. Joaquín Ruiz de Infante Abella / Bufete Ruiz de Infante;
4. Daniel Jiménez García / SLJ Abogados;
5. Luis Miguel López / López Castelo Abogados;
6. Cristo Ayose Suárez Pimentel / Abogados Pimentel / Pimentel Servicios Legales;
7. Cuatrecasas / Rosa Gual Tomás / Iñigo de Luisa Maíz / Adriana González García / Pedro Campaña Ávila;
8. Garrigues / Miguel Méndez / José María Martínez de Artola / Zulay Carmen Rodríguez;
9. Javier Sixto / Estefanía Sixto Seijas / Carlos Llamas Sanz / Sixto Abogados;
10. every further name in powers, filings, venias, invoices, LexNET notices, court headers, signature blocks and CC chains.

Do not treat this list as exhaustive. Unauthorised/unverified names remain B1, B2, B3… in public.
...
- every request to AC for authority, documents, access, payment, experts, estate protection or action against Community/CAM/Bankia;
- every AC refusal, approval, silence, warning, threat, venia/abstention request, payment decision or procurator communication;
- court records showing immediate procedural effect.
...
- **CLIENT/PROFESSIONAL REASON DOCUMENTED**
- **NO AC LINK LOCATED**
...
1. private master identity/mandate/source matrix;
2. public-safe A-series named register plus B-series coded backlog;
3. complete firm/counsel list with dates and clients;
4. withdrawal/substitution chronology;
5. AC act/omission and effect matrix;
6. strongest contrary-evidence column;
7. missing-evidence demand list;
8. ES/EN page update and correction log;
9. deletion-continuity audit;
10. propagation into AC, Calificación and Concurso routes where material.

The scan is complete only when every located name is included or expressly excluded with a reason.
