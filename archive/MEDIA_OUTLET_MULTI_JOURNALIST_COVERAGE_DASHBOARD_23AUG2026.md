...
|---|---|---|---|---|---|---|
| El Confidencial | Ruth Ugalde — real estate/hotel assets/restructuring | SENT / corrected package verified | Agustín Marco — deputy-director/business-investigations relevance | HOLD — extensive 2024 same-subject Gmail history; Ruth response window controls | PARTIAL | Do not treat as fresh cold target; no immediate second approach |
| Diario de Lanzarote | Saúl García Crespo — Yaiza/planning/courts/tourism | SENT + VERIFIED | Manuel Riveiro — current director/commissioning/local accountability | HOLD — already named as fallback in Saúl package | PARTIAL | Avoid duplicate package; reassess only after response-window review |
...
| Atlántico Hoy | Ariadna Martínez — economy/tourism/RIC/European funds | PROPOSITION ISOLATED / PREPARED LOCALLY / DUAL GMAIL GATE COMPLETE / ROUTE UNRESOLVED / NOT SENT | Martín Alonso — director/commissioning | VERIFIED CURRENT PROFESSIONAL / OUTLET-LEVEL LINKEDIN SIGNAL / NOT SENT | PREPARATION ONLY | Verify Ariadna's direct professional route; do not guess; one lane at a time |
...
| Cadena SER Canarias | Lourdes Santana — senior editorial/public-interest/economic/tourism | SENT + VERIFIED | Javi Rodríguez / Janire Alfaya — public administration/courts/public spending | VERIFIED CURRENT PROFESSIONALS / NOT SENT | PARTIAL | Apply outlet-level spacing; do not approach both together |
...
Current research/preparation order: Atlántico Hoy / Ariadna Martínez package prepared and held for route verification → RTVC / Ramón Betancor → EL ESPAÑOL-Invertia / Sandra Tobar → SER Canarias additional lanes subject to spacing → Cinco Días / Daniel Toledo Quer. Then continue the retrospective audit of El Confidencial, Diario de Lanzarote, La Voz de Lanzarote, HOSTELTUR, Canarias Ahora/elDiario.es Canarias, EL PAÍS, Biosfera Digital and Crónicas de Lanzarote.
