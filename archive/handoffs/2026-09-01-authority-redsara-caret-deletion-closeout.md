...
1. `archive/AUTHORITY_REDSARA_CARET_AND_THREAD_DELETION_CLOSEOUT_01SEP2026.md`;
2. `assets/data/authority-redsara-deletion-safety-caret-audit-v1.json`;
3. `archive/AUTHORITY_DISCOVERY_REDSARA_LIVE_CLOSEOUT_01SEP2026.md`;
4. `assets/data/institutional-communications-register-v1.json`; and
5. `assets/data/unitary-multitrack-criminal-first-gap-closure-v1.json`.
