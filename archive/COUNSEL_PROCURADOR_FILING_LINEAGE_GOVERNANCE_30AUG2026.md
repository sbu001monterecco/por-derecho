...
## 1. Mandatory two-register separation
...
Each person remains independently searchable and may still be linked into the master proceeding, filing and timeline graph.

## 2. Current perimeter corrections — controlling

The following classifications override any earlier wording that could imply these people were "our lawyers":

- **Juan Carlos Roque Prieto** — **NOT OUR COUNSEL PERIMETER**. Keep in the external/opposing/dissident-side professional register, with role, client, proceeding and dates established document by document.
- **Esteban Noriega** — **NOT OUR COUNSEL PERIMETER**. Keep in the external/opposing/dissident-side professional register, with role, client, proceeding and dates established document by document.
- **Álvaro Campanario** — **NOT OUR COUNSEL PERIMETER**. Keep in the external/opposing/dissident-side professional register, with role, client, proceeding and dates established document by document.
...
**Juan Tomás Parrilla Suárez is to be treated independently from Garrigues.**

Do not display, tag or narrate him as "Juan Tomás Parrilla / Garrigues" or otherwise fuse his identity with Garrigues merely because Garrigues appears elsewhere in the history. A dated primary source may establish a specific historic relationship for a specific event; if so, record that relationship only for the evidenced period/capacity and do not convert it into a permanent identity affiliation.

Maintain separate nodes for:
...
Every lawyer in either register must have a dedicated chronological filing register. For each item capture, where evidenced:
...
Create and maintain a master register of **every procurador and procuradora** involved in any connected proceeding. Identify them from primary procedural material wherever possible, including pleadings, LexNET receipts, poderes, apud acta, notifications, autos, providencias, diligencias, decretos and appeals.

For each procurador/a record:

- canonical full name;
- represented party;
- lawyer(s) paired with them for the relevant period;
- proceeding and pieza/incidente;
- first and last located appearance;
- personación / poder / apud acta evidence;
- filings presented;
- notifications received;
- substitution or termination where evidenced;
...
Every material procedural timeline event must identify, where established:

- represented party;
- lawyer;
- procurador/a;
- filing/act;
- filing/presentation date;
- court/body;
- resulting judicial/LAJ act;
- appeal/follow-up;
- change or continuity in representation.

The repository must support both directions:

- **professional → all attributed filings/proceedings**; and
- **filing/decision → party + lawyer + procurador/a + preceding/following procedural lineage**.

## 9. Instruction → filing → decision control

For our counsel perimeter, keep four propositions separate:

1. what the client instructed;
2. what counsel advised;
3. what was actually filed/presented;
4. what the court/LAJ actually decided or recorded.
...
- Is this professional **our current counsel**, **our former counsel**, or **external/opposing/dissident-side**?
- Which exact party did the person represent at that date?
- Which proceeding and pieza/incidente?
- Which procurador/a was paired with the lawyer at that time?
- What personación/poder/apud-acta authority is located?
- What exact filing was presented, by whom, and when?
- What judicial/LAJ response followed?
- Was there an appeal or later treatment?
- Has the professional's own filing register been updated?
- Has the master procurador/a register been updated?
- Has the master procedural timeline been updated?

No future counsel/procurador digest is complete until these questions are addressed or explicitly left as evidenced gaps.

## 11. No guilt-by-association / no perimeter-by-association

A professional relationship, firm relationship, common proceeding, professional friendship, later employment, family relationship or chronology does not transfer instructions, knowledge, intent, conduct or liability. Likewise, appearance in a connected matter does not make an external lawyer part of "our perimeter".
