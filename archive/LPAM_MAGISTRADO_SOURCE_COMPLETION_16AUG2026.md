...
The chain does **not** presently establish that:

- LPAM's asserted friendship/contact account was true;
- the Judge and LPAM had an intimate friendship or prohibited relationship;
- any improper communication or influence occurred;
- LPAM personally represented CAM in the 18-May event as a matter of official attendance/powers record;
- the €350,000 line was paid, who received it, or that it had any connection to the Judge;
- an observed greeting/brief exchange was a private conversation or private meeting;
- the 18-May Auto was backdated, predetermined or improperly prepared;
- the asserted relationship continued into 2025 or affected Sentencia 163/2023; or
- the CGPJ has joined or substantively examined the 28-July package within Alzada 286/2026.

## 2. Source-by-source classification

### 2.1 24 January 2018 — direct contemporaneous email

**Status: VERIFIED CONTEMPORANEOUS RECORD / LIMITED PROPOSITION.**

The recovered email records, in the relevant cost breakdown, a line `Intermediación/Comisiones (3%) - 350.000,00` together with financing and transaction figures.

**Permitted use:** it proves that this cost/commission line was contemporaneously recorded in the commercial context.

**Prohibited upgrade:** do not state from this email alone that €350,000 was actually paid, identify a recipient, characterize the payment as unlawful, or connect it to the Judge. Those are separate proof questions.

### 2.2 5 June 2020 — contemporaneous memorialisation
...
### 2.3 12 May 2021 — Auto 154/2021 / bidding call

**Status: VERIFIED PRIMARY COURT RECORD.**

The primary court document records **Construcciones Acosta Matos, S.A.** as a creditor/participant, represented procedurally by procurador **Pedro Serrano Rodríguez**, and calls the 18-May bidding event.

This independently establishes CAM's procedural presence. It does **not** identify LPAM personally as CAM's attendee or representative at the later event.

### 2.4 18 May 2021 — Auto 164/2021 / event and outcome
...
- `El presente documento ha sido descargado el 18/05/2021 11:50:54`; and
- electronic signature by Alberto López Villarrubia at `18/05/2021 - 12:47:38`.

This ordering is a **documentary/technical anomaly** in the preserved official copy. It justifies a finite technical request concerning generation, signature, download, availability and notification workflow. It is **not by itself proof of alteration, backdating, predetermination or misconduct**.

### 2.5 28 July 2026 — separate witness declarations
...
Canonical direct-observation formulation:

> The witnesses say they observed the Judge leave, greet LPAM/people with her, exchange brief words and smiles/handshake-type courtesies. They do not claim to have heard the content, seen LPAM enter chambers, or seen LPAM and the Judge alone.

### 2.6 28–30 July 2026 — CGPJ procedural route

**Status: FORMAL PRESENTATION + DOWNSTREAM REGISTRY ROUTING VERIFIED; JOINDER/EXAMINATION OPEN.**

`REGAGE26e00069061338` formally presented the five-file LPAM–Magistrado package on 28 July 2026.

A REC notification dated 30 July 2026 states that the presentation **`ha pasado a ser tramitada por` the CGPJ General Registry**, with routing time **08:36:02**.
...
## 4. Calificación relevance — exact boundary

The LPAM–Magistrado module is relevant to the Calificación page only as a **separate appearance-of-impartiality and finite-verification question** surrounding a Judge who later adopted selected AC/Fiscal propositions as his own findings in Sentencia 163/2023.

It is not valid to reason:

`LPAM statement/witness observation → proven relationship → proven bias → Sentencia 163/2023 criminally procured`.

The valid evidential sequence is:

`contemporaneous witness-account source + later separate observations + official procedural records → finite verification targets → only then any legally relevant relationship/recusal/knowledge question → proposition-by-proposition test against later judicial acts`.

No current source proves that a historical relationship/contact assertion affected Sentencia 163/2023.
...
5. No controlled source identifies the recipient/payment of the 2018 €350,000 commission line.
6. No controlled source establishes persistence of the asserted relationship into 2025.
7. CGPJ's 14-May archive reasoning remains contrary institutional evidence and must stay visible.
8. Formal filing/routing does not prove substantive examination or merits.
...
A filing in CGPJ, Fiscalía, Control 21, DP 1901 or another later package that contains the same 2018/2020 email or declaration is a **new transmission/knowledge event**, but it is not independent corroboration of the underlying relationship/contact proposition. Record both layers separately.
