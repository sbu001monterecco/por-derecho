...
12. `CURRENT_HANDOVER_UNITARY_RECOVERY_21AUG2026.md` and current correction/missing-evidence controls; and
13. connected Gmail in both directions for any recipient/topic being considered.
...
The 23-Aug-2026 Civismo / Diego Sánchez de la Cruz routing email is the triggering correction: it was sent with the webinar and two PNG source maps but accidentally omitted the website link. Preserve that sent history accurately; the omission does not itself authorise a corrective resend.
...
- **Diego Sánchez de la Cruz** is now included neutrally in `archive/JOURNALIST_MEDIA_REGISTER.md` with dual-role legal-certainty / investment-climate relevance; outreach history remains private/controlled.
...
- The neutral bilingual media-briefing routes remain a **genuine open recommendation** unless a later thread verifies they have been implemented.

Current high-level open recommendations therefore include:

- neutral bilingual media briefing routes;
- separate Tier-A media packages rather than mixed mass CC distributions;
- private follow-up intelligence queue;
- formal-channel matrix distinguishing email notice from operative filing; and
- current-state sitemap/discoverability/runtime re-audit.

## Reusable lessons from the 23-Aug Diego / journalist outreach thread
...
No email may be sent without the user's separate explicit final approval of the exact recipients, subject/body, attachments/versions and links.
