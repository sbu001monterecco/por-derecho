# Master continuity handover — Ministerio Fiscal / First Frame / Justice Map

**Project Sun Rock · Sun Park / LPB / Aweswell / Matkator · 15 August 2026**
...
**Archive once. Verify once. Reuse continuously.** Every serious proposition must remain distinguishable as `DOCUMENTED`, `CORROBORATED`, `DISPUTED`, `ANALYTICAL_QUESTION`, `OPEN_EVIDENTIAL_GAP`, `SUPERSEDED`, or internal working hypothesis. Allegation does not become fact through repetition.
...
## First Frame / institutional anchoring

Public-safe proposition: the earliest located prosecutorial frame treated the insolvency administrator as a material information source and Gil/Patricia as persons investigated. When Gil/Aweswell later became complainants against the AC/CAM/private-actor perimeter, the earlier criminal lane was still active. This creates a legitimate analytical question of institutional anchoring, role fixation and asymmetric credibility allocation.

Do **not** publish as established: personal bias, personal affinity, collusion, capture, deliberate shielding, knowingly false prosecution or corrupt agreement.

Preferred public wording:

> The record raises the question whether later materially different allegations were reconsidered independently or through an inherited institutional frame formed when the same parties occupied reversed procedural roles.

## Named fiscals — controlled status
...
The February 2019 new-evidence filing requested, among other measures, statements from the insolvency administrator, José Daniel Acosta Matos and Laura Acosta Matos. Determine from the complete certified DI 248 file which requested diligencias were actually carried out before the 7 May 2019 archive. Do not state that none were done unless the complete file proves it.

Comparative question: compare investigative intensity in the earlier AC-originated criminal lane with the later Gil/Aweswell complaint while controlling for different offences, evidence and procedural circumstances.

## DP 1132/2018 — high-value bridge

A July 2018 providencia indicates that the existence, composition, representation, contractual basis and tourism title of the Comunidad de Explotación were matters of judicial verification, not self-evident assumptions. A working reconstruction of Borja Rodríguez-Batllori's 31 July 2018 testimony describes a possible `private request → AC authorisation → physical implementation → court notice` chain. Do not quote that working reconstruction publicly until checked against certified testimony, audiovisual record or official transcript.

## Scope & Perimeter

Maintain these legal/entity boundaries across all site and Depository work:

- **LPB** — debtor/estate layer; do not describe the whole hotel as insolvent.
- **Comunidad** — collective governance/exploitation layer; authority over common elements does not automatically establish authority over private LPB or Matkator units.
- **Monterecco/Pink** — operator layer; not automatically identical to LPB.
- **Matkator** — separate non-concursada property-owner layer; AC powers over LPB do not automatically extend to Matkator.
- **CAM/HNT/MYND** — later creditor/title/beneficiary/operator layers requiring asset-by-asset verification.

## Control before title

Maintain separate dates for physical access, possession/control, security, project planning, credit acquisition, economic expectation, adjudication, registered title, segregation, hotel operation and investor representations. Later 2022 title does not retrospectively resolve authority for 2017–2018 access/control acts.

The BORME CAM→HNT segregation describes a Sun Park economic unit transferred for transformation and MYND operation; that notice does not by itself prove valid title to every asset used downstream.
...
The public-safe pressure point remains: a factual premise used in the archive reasoning concerning appeal status was contradicted by the appeal record, and the institution was formally notified on 11 March 2026 (REGAGE26e00026303869). The public question is what happened after correction. Do not say “the prosecutor lied.”

## GUB 86/2026 / Audiencia Nacional

Preserve the Fiscalía AN → Fiscalía de Área de Arrecife-Lanzarote-Puerto del Rosario movement as a competence/routing act, not a merits decision. Missing: destination territorial reference, assigned fiscal and substantive action/outcome.
...
- `es/justicia-registro-institucional/`
- `en/justice-institutional-record/`

Every public node should identify what it establishes and what it does not establish. The public visualisation must render evidence and uncertainty; it must not operate as a conspiracy graph.

## Cross-cutting registers to maintain

1. Scope & Perimeter
2. Notice & Knowledge — who knew what, when?
3. Investigative Intensity — requested versus actually performed diligences
4. Role / Entity Separation
5. Control Before Title
6. Scope Mismatch
7. Named Prosecutor Register
8. Fiscalía ↔ Court Participation
9. Referral / Routing Register
...
11. Finca-by-finca LPB/Matkator/CAM/HNT title, access, works, operator and income matrix.
