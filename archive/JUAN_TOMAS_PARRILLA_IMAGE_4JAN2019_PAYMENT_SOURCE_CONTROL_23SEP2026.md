# Juan Tomás Parrilla — image, 4-Jan-2019 protective draft and counsel-transition source control

**Control date:** 23 September 2026  
**Status:** evidence-led working control; allegation boundaries preserved  
**Matter:** Luchy Playa Blanca, S.L.U. — Concurso Ordinario 36/2012

## 1. Identity and role

**Juan Tomás Parrilla Suárez** is tracked in the Por Derecho evidence architecture as former insolvency counsel for Luchy Playa Blanca, S.L.U. in Concurso 36/2012, with the located record placing him in the representation from the opening phase of the concurso through the 2020 transition. Act-specific attribution remains source-dependent.

## 2. Canonical image

A cleaned and cropped conference photograph has been registered as the current canonical visual reference for this workstream:

- filename: `Juan_Tomas_Parrilla_canonical_20260923.jpg`
- transformation: crop removed the unrelated standing attendee at the left; clarity/sharpness enhanced; no allegation text or graphical annotation embedded
- identity provenance: **user-supplied identification**, not independent biometric/face-recognition verification
- custody: the untouched source image and the edited derivative must remain separately preservable

The image may be used as an identification/illustrative asset only. It does not itself prove any conduct, relationship, knowledge, payment or liability.

## 3. The 4-Jan-2019 protective draft
...
A contemporaneous email from Armando Betancor Álamo transmitted the draft and its four documentary annexes, describing it as the pleading **to be presented by Juan Tomás**. This establishes preparation and transmission for contemplated filing. It does not establish that the pleading was actually filed.

### Direct non-filing rationale — 9 Jan 2019

A contemporaneous email chain records Parrilla's own stated position after discussion with Patricia and Rosa Gual. Parrilla wrote, in substance, that before challenging the sale in the Mercantile Court they needed the deed to know exactly what had been done and how; that premature allegations could produce a premature court response; and that he therefore was **not in favour of filing anything substantive at that stage**, save potentially a narrower request that the court require the Administrador Concursal to produce the deed.
...
A later client-side email to incoming lawyer Daniel Jiménez states that the 4-Jan-2019 pleading drafted by Armando Betancor remained unfiled because Parrilla refused to present it, and also refused to present his own version.
...
Planned visual nodes:
- Juan Tomás Parrilla — canonical image
- 4-Jan-2019 draft — central documentary spine
- Administrador Concursal Francisco de Borja Rodríguez-Batllori Laffitte
- José Daniel Acosta Matos and Laura Patricia Acosta Matos
- Grupo Acosta Matos / MYND Hotels / Canarian Hospitality / RIC Private Equity — only with relationship labels supported by current source control
- PwC España / RSM España / Grant Thornton España — contextual/professional nodes only; logo placement must not imply participation in alleged wrongdoing absent a specific sourced proposition
