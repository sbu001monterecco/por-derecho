# SUN PARK MASTER STORYLINE — 2022 ADJUDICATION RECONCILIATION ADDENDUM

**Date:** 19 August 2026  
**Status:** `CANONICAL TIMELINE ADDENDUM — controls the 2021/2022 adjudication node where more specific than the 16-Aug master timeline`  
**Companion:** `SUN_PARK_MASTER_STORYLINE_TIMELINE_1989_2022_16AUG2026.md`

## Purpose

The 16-Aug master timeline correctly separates pre-title control/project activity from 2022 formalisation, but its compact 21-Feb-2022 reference to a separate Arrecife dación/mortgage-cancellation chain is not sufficient for the now reconstructed Concurso 36/2012 adjudication sequence.

This addendum prevents three errors:
...
| Date | Event | Current source status | Controlled significance |
|---|---|---|---|
| **23 Jul 2019** | AP decision sets better-posture components, including first-rank default interest of **€3,079,104.66 + daily accrual up to €3,182,000 mortgage cap** | **PRIMARY content recited in signed 25-Jan-2021 Auto; exact AP binary still to bind** | establishes origin of later €102,895.34 movement |
...
| **28 Feb 2022** | LPB files appeal against definitive-sale order chain | primary filed appeal located | contemporaneously preserves challenge and quotes differentiated court-approved sale structure |
| **2 Mar 2022** | Aweswell appeal source preserves same differentiated sale structure | party procedural source located | corroborates dación + separate €400k direct-sale framing |
| **Later 2022** | Registry/title/cancellation and CAM→HNT segregation consequences | controlled elsewhere | reconcile against exact deed; downstream title does not prove every antecedent step had identical legal/economic function |

## Interest transition — now explained, not merely observed

The signed 25-Jan-2021 Auto records:

- 2019 AP first-rank default interest: **€3,079,104.66**;
- continuing daily default interest until mortgage cap: **€3,182,000**;
- Jan-2021 better-posture requirement: full **€3,182,000**.

Thus:

`€3,182,000 − €3,079,104.66 = €102,895.34`.

Use this as:

> **a source-supported interest-accrual transition inside the better-posture calculation**, not as an unexplained inflation, fabricated interest or automatically recognised concursal credit.

The underlying CAM calculation, exact days/rate and credit-classification effect remain open.

## 29-Jan-2021 Edicto — timeline-critical arithmetic

- mortgage components: **€13,168,082.02**;
- plus separate non-mortgaged-asset component: **€400,000**;
- derived subtotal: **€13,568,082.02**;
- plus community fees: **€1,145,798.29**;
- quantified total before taxes/costs: **€14,713,880.31**.
...
Until all same-date instruments are rebound:

> **21 February 2022 is a legal-instrument reconciliation point. The Concurso 36/2012 deed implementing the adjudication/sale chain must be identified separately from any Arrecife execution/dación/mortgage-cancellation instrument of the same date. Do not merge their parties, fincas, debt extinction, legal basis or Registry effects by chronology alone.**

Required fields for each instrument:

`PROCEEDING → NOTARY/PROTOCOL → PARTIES → FINCAS → LEGAL TITLE → CONSIDERATION / DEBT → CANCELLATIONS → REGISTRY ENTRY → DOWNSTREAM EFFECT`.

## Five thresholds for the reader
...
The existence of each threshold does not prove the next one was invalid. The forensic task is to identify the legal/economic bridge between them.
