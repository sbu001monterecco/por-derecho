...
| Calificación culpable / Sentencia 163/2023 / parallel lives | `/es/calificacion-concurso-36-2012-vidas-paralelas/` + `/en/insolvency-classification-parallel-lives/` | `archive/CALIFICACION_CONCURSO36_PARALLEL_LIVES_PUBLICATION_CONTROL_16AUG2026.md` | LIVE V1 / **materially adverse first-instance judgment disclosed; LPB-only perimeter; AC/Fiscal/Judge roles separated; misuse/instrumentalisation thesis expressly OPEN pending source-complete scan** | re-query complete AC report+annexes, 12-Mar-2019 Fiscal opinion/source set, oppositions, 25-Jul-2023 hearing evidence, appeals/current AP status; then build AC→Fiscal→opposition→evidence→finding→appeal→extra-insolvency matrix |
| Banking origin / LPB insolvency / Execution 90/2012 / sale-lender convergence / Valencia / PH122→CAM assignment | `/es/acreedor-de-registro/` + `/en/lender-of-record/`; `/es/insolvencia-lpb/` + `/en/lpb-insolvency/`; `/es/convergencia-venta-acreedor/` + `/en/sale-lender-convergence/`; dedicated ES/EN assignment/Article-1535 routes | `archive/BANKING_ORIGIN_GAP_CLOSURE_LEDGER_16AUG2026.md` + `archive/VALENCIA_BANKING_CONCURSAL_RECONCILIATION_LEDGER_16AUG2026.md` + `archive/LPB_INSOLVENCY_SALE_LENDER_CONVERGENCE_PUBLICATION_CONTROL_16AUG2026.md` + `archive/PH122_CAM_ASSIGNMENT_ART1535_PUBLICATION_CONTROL_16AUG2026.md` + UK/Spanish name-continuity controls | LIVE / **primary auction count corrected to 158; LPB-only insolvency perimeter and sale-lender convergence separately public; asset-surplus/cash-flow distinction preserved; pre-concurso direct-market platform published; UK/Spanish name continuity controlled; PH122→CAM assignment/price/Article-1535 dispute public with adverse 8-Feb-2018 ruling disclosed; overall banking readiness remains source-dependent** | ME-051–059 + ME-061: native default/ledgers; full Execution 90/2012; 158/159/166 finca crosswalk; acquisition/control and privilege review; exit-response matrix; operator dataset; Valencia public-safe bundle; complete protocol 2,248/price/payment; 1041/2017 outcome; exact pre-20-Oct-2017 claim/opposition + response for technical Article 1535 analysis |
...
| Acosta Matos / Sun Park private-actor perimeter | `/es/acosta-matos-perimetro/` + `/en/acosta-matos-perimeter/` | P19 dated control chain + `archive/RICPE_ORION_PLATFORM_CONTINUITY_15AUG2026.md` | LIVE / **pre-title entry/control role + Sun Park→Pamalexsha/CAM→RICPE/AGM→Orion continuity under source control** | actor-by-actor role ladder: credit, units, access, project, practical control, adjudication, later governance/benefit; prove Q4-2017/2018 instructions and preserve legal-person separation |
