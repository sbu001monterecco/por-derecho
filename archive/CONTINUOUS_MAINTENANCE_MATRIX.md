...
| Acosta Matos perimeter | `/es/acosta-matos-perimetro/` | dated control chain + institutionalisation chain | LIVE / widened to RICPE governance + later platform reuse | title/authority/control/benefit evidence by entity/date; RICPE conflict/governance records; AGM/Orion primary corporate records; preserve legal-person separation |
| RIC Private Equity Investment Partners, SCR, S.A. (RICPE) | `/es/ricpe-responsabilidad-documental/` + `/en/ricpe-documentary-accountability/` | RICPE evidence chain + `INSTITUTIONALISATION_CHAIN_RIC_EU_REGIONAL_15AUG2026.md` | LIVE / strengthened 15 Aug / governance→knowledge→capital→public-support reconciliation | ME-033 + ME-035: native 2023 audited-account pages; all Series F/G project versions; 2019–22 board/committee/conflict/abstention records; Control Unit; loan agreements; drawdowns/payment trail; due-diligence originals; response to Aug 2026 requirement |
| RIC → regional incentives → EU co-financing → current exploitation | `/es/cadena-instrumentalizacion-ric-fondos-incentivos/` + `/en/institutionalisation-chain-ric-eu-incentives/` | `archive/INSTITUTIONALISATION_CHAIN_RIC_EU_REGIONAL_15AUG2026.md` + extraconcursal audit | LIVE / evidence-first / three-plane ongoing-harm + serial-reliance chain | ME-033 + ME-034 + ME-035; actual testimony→notary/Registry bridge; asset/right map LPB/Matkator/third parties; current use/revenue map; funding-source and eligible-cost reconciliation |
| RICPE → Orion Rental SOCIMI platform continuity | `/es/orion-ricpe-continuidad/` + `/en/orion-ricpe-platform-continuity/` | `archive/RICPE_ORION_PLATFORM_CONTINUITY_15AUG2026.md` | LIVE / platform-continuity branch / no money-flow inference | ME-036: Orion incorporation/shareholder/capital files; RICPE contribution bank trail; later capital increases; AGM mandate/governance; investor-source and financing/security records; evidence proving or excluding Sun Park/MYND value flow |
| CNMV | ES/EN CNMV-RICPE verification page | institutional outward-wave ledger + institutionalisation chain | LIVE / strengthened with CNMV primary source + governance context | supervisory corpus index; whether July 2021 docs later incorporated/reassessed; corrective/referral record; distinction regulated status ≠ project approval |
...
| Intervención General / SIINF | ES/EN verification page | outward-wave ledger | LIVE | salidas 184368/2026 and 497011/2026; referral/receipt logs; reconcile control perimeter with GC/836/P06 and current EU-cofinancing representation |
| SNCA / IGAE / EU funds | `/es/snca-fondos-europeos-trazabilidad/` + `/en/snca-eu-funds-traceability/` | outward-wave ledger + institutionalisation chain | LIVE / strengthened 15 Aug with GC/836/P06 + current EU-cofinancing context | Exp. 141-2026-IRR02 complete index/verification notes; ME-034 complete GC/836/P06 substantive grant/control file; EU source/percentage/certifications/payments; Infofraude reconciliation |
...
## Controlling cross-track rule — 15 Aug 2026
...
Add the separate RICPE→Orion branch where relevant. **Platform continuity is not money-flow proof.** Do not infer that Sun Park/MYND revenue, RIC financing, regional-incentive support, EU-cofinanced expenditure or disputed asset value funded Orion without a primary financial bridge.
...
Where multiple institutions or professional gatekeepers act in sequence, ask what each one independently checked against the underlying asset/right source. Do not treat a later formalisation, registration, tax idoneity, supervisory status, grant decision or operational contract as automatic validation of every upstream factual premise.
