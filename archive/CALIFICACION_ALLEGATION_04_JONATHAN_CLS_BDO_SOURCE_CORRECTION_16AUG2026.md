# CALIFICACIÓN — ALLEGATION 04 — JONATHAN SIMÓ / CLS / BDO SOURCE CORRECTION

**Date:** 16 August 2026  
**Status:** CONTROLLING SOURCE-CORRECTION ADDENDUM TO `CALIFICACION_ALLEGATION_04_ACCOUNTING_BOOKS_SUBSTANTIAL_BREACH_LEDGER_16AUG2026.md`

## Correction

Do **not** state as an objective fact that LPB failed to keep or failed to supply a statutory `Libro Diario` during the concurso merely because Sentencia 163/2023 says that the Libro Diario was not supplied.

That is an **ADVERSE FIRST-INSTANCE FACTUAL/JUDICIAL FINDING UNDER APPEAL**. The connected documentary record contains contemporaneous evidence pointing materially in the opposite direction and therefore requires the finding itself to be tested.

## Newly re-opened source family
...
### 2. Jonathan Simó / CLS — Diario in 2015
...
The message states that the tax drafts were prepared from the **annual accounts prepared by BDO for 2011–2012–2013**, with a 2014 summary also available.

This is contemporaneous evidence that a Diario-level accounting file existed in 2015 and that CLS was actively maintaining/reconciling LPB accounting during the concurso.
...
## Correct evidential formulation

The controlling proposition is now:

> **Sentencia 163/2023 makes an adverse first-instance factual finding that the statutory Libro Diario was not supplied to the AC. That finding is disputed on appeal and is materially challenged by contemporaneous documentary evidence showing continued Diario-level accounting, CLS maintenance of LPB accounting during the concurso, BDO preparation/review of annual accounts, and prior delivery of accounting journals. The repository therefore does not adopt the non-supply proposition as objective fact.**

## What remains to prove

The finite evidential test is:

`YEAR → EXACT DIARIO FILE/BOOK → ACCOUNTANT/CUSTODIAN → DATE PREPARED → FORMAT → LEGALISATION (IF ANY) → TRANSMISSION TO AC → AC RECEIPT/ACKNOWLEDGEMENT → AC USE → LATER COURT EVIDENCE`.

Priority years are 2012, 2013, 2014, 2015 and 2016, with 2017 added if accounting continued after the relevant cut-off.

## Knowledge / accountability consequence

The court's adverse finding cannot safely be paraphrased by Por Derecho as `the Libro Diario was missing` or `LPB did not keep the Diario`.

The source-complete formulation is:

- **Court finding:** Diario not supplied — adverse, appealed.
- **Contemporaneous contrary evidence:** substantial and specific.
- **Objective historical question:** unresolved pending the complete year-by-year transmission/receipt file.

If the complete CLS/BDO/AC transmission trail proves that the relevant Diario was in fact delivered, the first-instance finding would be factually contradicted by primary evidence. That conclusion should be made only after matching the exact files, dates, recipients and acknowledgements.
