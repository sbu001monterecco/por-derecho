# elEconomista / Javier Romera — media traceability control

Date: 15 August 2026  
**Evidence refresh: 16 August 2026**  
Status: evidence-led public-page control file

## Controlling conclusion after primary-source refresh

The January 2025 episode is now materially better evidenced.
...
That judgment is materially adverse and must not be minimised. However:

1. it is a **sentencia**, not an auto;
2. its debtor/subject is **LPB**, not the Sun Park hotel/real-estate complex as a whole;
3. the operative disqualification language runs from the **finality** of the ruling;
...
### A. Primary / direct evidence located

#### A1. Javier Romera email — 20 January 2025

Gmail message ID: `19484f01841fdc36`  
Subject: `RV: Mynd Yaiza`  
From: Javier Romera  
Attachment: `AUTO CONCURSO CULPOSO.pdf`

Romera wrote that the newsroom had been sent an “auto” declaring the “concurso de Sun Park” culpable and Gil disqualified, and that “con esto” they could not publish.

**What this proves:**
- the newsroom received a judicial document;
- Romera used the “auto / concurso de Sun Park” characterisation;
- he linked that material to the communicated decision not to publish.

**What it does not prove:**
- who physically sent the attachment;
- what accompanying representation was made by the sender;
- whether Romera independently verified the legal nature, debtor, scope, appeal status or relevance of the judgment.

#### A2. Actual attachment — Sentencia 163/2023

Local recovery during the 16-Aug-2026 refresh: `/mnt/data/AUTO CONCURSO CULPOSO.pdf`.

The attachment itself identifies:
- **Sentencia 163/2023**;
- date: **28 September 2023**;
- Juzgado de lo Mercantil nº 1 de Las Palmas;
- calificación of **Luchy Playa Blanca, S.L.U., Concurso 36/2012**;
- operative declaration that the **concurso of Luchy Playa Blanca, S.L. is culpable**;
- specified affected persons/consequences;
- Gil Marer’s disqualification period calculated **from the finality of the ruling**;
- an express appeal route to the Audiencia Provincial.

**Controlling correction:** never describe this attachment in repository/site material as an “auto declaring Sun Park culpable”.

#### A3. Appeals / appellate context predating January 2025

Located Gmail records include:

- `18b80d97aedc93aa` — 30 Oct 2023 appeal package for Gil Marer (`20231030 Apelacion calificacion GIL.pdf`);
- `18b816900fede92f` — 30 Oct 2023 Pink Canary Services / Patricia Domínguez appeal package;
- `18b90bb207d7ed8d` — 2 Nov 2023 lawyer email stating an appeal had been filed;
- `18b908ad64f3da0f` — contemporaneous circulation of filed classification appeals;
- `18ca55ecf0948b25` — 26 Dec 2023 appellate personation material before the Audiencia Provincial;
- `18fed216948d833b` — June 2024 invoice expressly referring to the classification appeals.

**Safe proposition:** multiple appeals were already on record before the January 2025 media exchange. Do not state a later/final appellate outcome without a current primary appellate record.

#### A4. Press pitch — 16 January 2025

Gmail message ID: `1946e6af3c54df65`  
Attachment: `Nota de Prensa 16ENE2025.pdf`.

The press material put forward for journalistic investigation included:
- alleged unauthorised or disputed commercialisation/control of Sun Park;
- Meeting Point / FTI commercialisation questions;
- CAM / Acosta Matos participation;
- RIC / RICPE investment/governance questions;
- public and European funding/incentive questions;
- mixed ownership, exploitation and institutional-supervision issues.

**Evidence rule:** the press note proves the subject matter presented to the journalist. It is not independent proof of its allegations.

#### A5. Lars Creutzmann / Meeting Point notice — 3 January 2025

Gmail message ID: `1942d4f98806252f`  
Attachment: `Notice to Lars Creutzmann ref MeetingPoint 03JAN2025.pdf`.

The formal request asked Meeting Point/Lars to confirm, preserve and disclose whether any Meeting Point/group entity had:
- marketed, distributed, sold, offered or promoted Sun Park;
- entered allotment, distribution, accommodation, tour-operator, bed-bank, management, franchise, brand, OTA, inventory or resale arrangements;
- exercised access, promotion, inventory-control or exploitation rights;
- dealt with CAM/Acosta Matos, LPB, Matkator, Aweswell or related parties concerning the hotel;
- held records relevant to mixed/private ownership.
...
Gmail message ID: `194747a2c629ed8c` and the 19-Jan continuation `1947f6ca724f2e49`.

A contemporaneous record sent to Romera states, in substance:
- Meeting Point was saying it had **never commercialised the hotel**;
- Laura/CAM was saying Meeting Point **had commercialised it** at some stage.
...
Romera expressly denied an attempt at censorship and stated that before publishing the newsroom needed to have the relevant material properly verified / “bien atado”.

**Fairness rule:** retain this in every public treatment. The accountability question is whether the same standard was applied to the attachment that later stopped publication, not whether the outlet had a duty to publish.

#### A8. Meeting Point proceeding 357/2024 supplied to Romera — 19 January 2025

Recovered attachment: `357-2024 PRORROGA NEGOCIACIONES MP Registro Concursal 19ENE2025 (3).pdf`.

It identifies:
- Juzgado de lo Mercantil nº 3 de Las Palmas de Gran Canaria;
- proceeding **357/2024**;
- a 24 Oct 2024 extension affecting Meeting Point Hotelmanagement (Canaries), S.L.U.; Meeting Point Spain, S.L.U.; and Meeting Point Investment, S.L.U.;
...
## B. Strong inference, not verified attribution

### Who sent the judgment to elEconomista?

The native inbound transmission to Romera has not been located. The exact individual sender therefore remains open.

The contemporaneous sequence places receipt of the judgment inside a verification exchange involving responses attributed to the CAM/Acosta Matos side and Meeting Point. The strongest controlled inference is:

> **The judgment appears to have entered the January 2025 newsroom exchange from or on behalf of the CAM/Acosta Matos response side. The present evidence does not establish which person physically sent it, from which account, or under whose specific instruction.**

Do **not** upgrade this to:
- “LPAM sent it”;
- “the insolvency administrator sent it”;
- “X sent it on LPAM’s direct instruction”;
- or any other person-specific transmission claim without the native message/headers or equivalent primary proof.

Gmail `19489325e0f88b84` is a contemporaneous internal subject line referring to a document “aportado por LAURA ACOSTA MATOS”. It supports the response-channel inference but is still a party-authored attribution rather than sender metadata.

---

## C. Legal-scope comparison — what Sentencia 163/2023 did and did not decide

### It did decide

- the culpable classification of **LPB’s concurso** at first instance;
- affected persons and specified consequences within that classification;
- disqualification language and other operative consequences.
...
- every post-takeover or post-liquidation act alleged in the press pitch;
- the truth or falsity of the press pitch as a whole.

Therefore the judgment was **materially adverse but not dispositive of the proposed media story**.

---

## D. Meeting Point 357/2024 judge/registry chronology — correction discipline

A March 2025 Gmail record (`19570f670d5625ee`) expressly corrects an earlier assumption that one Registry entry had simply replaced another. The preserved Registry material was described as containing:
- a 24 Oct 2024 publication/act bearing **Alberto López Villarrubia**; and
- a later 18 Feb 2025 publication/act bearing **Guillermo Fernández García**.

The correction email states that two records appeared rather than proving a simple overwrite/replacement.

**Controlling rule:** do not infer judicial impropriety, irregular replacement, shared knowledge or coordination from the appearance of different judicial names on different acts. The only legitimate unresolved question is procedural provenance: reparto, assignment/substitution/reinforcement if any, signature, date, and which judge actually received any Sun Park-related material.

---

## E. Editorial-accountability formulation
...
## F. Source-completion queue

1. Obtain the original inbound message by which `AUTO CONCURSO CULPOSO.pdf` reached elEconomista, including sender, recipient, timestamp, headers, body, attachment and hashes.
2. Obtain/export the native 20-Jan Romera email with full RFC headers and hash the attachment against the recovered copy.
3. Obtain the complete filed March-2025 Madrid querella package, especially exhibits said to contain the relevant transmission/attachments.
...
Public pages may now state as verified that:
- the attachment was Sentencia 163/2023, not an auto;
- it concerned LPB’s Concurso 36/2012, not “Sun Park” as the whole hotel;
- appeals had already been filed before the January 2025 media exchange;
- the judgment’s disqualification language refers to finality;
