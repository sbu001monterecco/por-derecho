# Garrigues / La Laguna PO 344/2013 - evidence and communications register
...
- Proceeding: Procedimiento Ordinario 344/2013.
- Decision: Sentencia 41/2014, 18 February 2014, seven pages.
- Claimant: J&A Garrigues, S.L.P.
- Defendants: Gil Marer and Patricia Domínguez Montelongo.
- Defendants' counsel: Juan Tomás Parrilla Suárez.
- Principal claimed: EUR 63,441.67 plus interest and costs.
- Outcome: claim dismissed in full; first-instance costs imposed on Garrigues.

This proceeding concerns Garrigues's fee/guarantee claim. It is not the separate LPB-Monterecco/Pink advice, contract-validity or later insolvency-classification lane. Common actors and documents do not merge those legal matters.

## Evidence inventory

| Evidence ID | Date | Source and status | Public treatment |
|---|---:|---|---|
| GLL-001.ORG | 18/19 Feb 2014 | Original `Sentencia 344-2013.pdf`, seven pages, 319,679 bytes; recovered as an attachment to a contemporaneous email. SHA-256 `1d39af97262c5031a78c6857c96476f605c3e1c397968a0952b755d3d9ac8b2a`. | Native binary withheld. Full substantive Spanish transcription published with administrative identifiers, contact data and signatures removed. |
| GLL-001.TXT | 24 Aug 2026 | Page-image OCR derivative checked against all seven rendered pages. | Public controlled transcription. The source's internal variants `1241/2011`, `1241/2009` and `1271/2011`, and isolated invoice reference `10814806`, are preserved as printed and flagged. |
| GLL-002 | 2013 | Filed Garrigues claim and annexes. | **Not located.** Only a judgment-derived reconstruction is published; it is not represented as the original pleading. |
| GLL-003 | 2013 | Filed defence and annexes. | **Not located.** Only a judgment-derived reconstruction is published; it is not represented as the original pleading. |
| GLL-004 | 23 Nov 2015 | Later insolvency order applying res judicata to four invoices. | Result summarised; certified complete source remains a production target. |
| GLL-005 | 28 Apr / 1 Jun 2016 | Definitive creditor-text materials. | Public-safe result: EUR 51,156.67 excluded; EUR 12,285 retained. Native source remains in controlled systems. |
| GLL-COM-001 | 9-17 May 2012 | Contemporaneous payment correspondence concerning HAVAVIDA T&T, S.L. and Garrigues. | Summary only. Private bodies, addresses and bank/account data withheld. |
| GLL-COM-002 | 24 Nov-9 Dec 2013 | Contemporaneous attempt to escalate and resolve the Garrigues dispute. | Summary only; no private email body published. |
...
The court's judgment records the parties' positions, but it is a judicial summary. Until GLL-002 and GLL-003 are recovered, every public description of those pleadings must carry:

`RECONSTRUCTION FROM SENTENCIA 41/2014 - ORIGINAL PLEADING NOT LOCATED`

Do not use `full claim`, `full defence`, `digitised original`, `complete annexes` or equivalent for the reconstructions.

## Invoice reconciliation

| Invoice | Amount | Judgment treatment | 2016 insolvency treatment |
|---|---:|---|---|
| 10015483 | EUR 9,450.00 | Separate litigation engagement; not guaranteed by Gil/Patricia in this claim. | Retained. |
| 10015502 | EUR 12,142.23 | Mixed/predominantly Bankia restructuring; inadequate task/hour allocation. | Excluded. |
| 10015503 | EUR 2,835.00 | Tax advice outside the guaranteed engagement. | Retained. |
| 10015504 | EUR 8,300.25 | Some work evidenced; inadequate task/hour allocation. | Excluded. |
| 10015505 | EUR 13,183.56 | Some work evidenced; inadequate task/hour allocation. | Excluded. |
| 58000002113 | EUR 17,530.63 | Mixed/predominantly Bankia restructuring; inadequate task/hour allocation. | Excluded. |
...
Exact bank proof, costs taxation, costs collection and account application remain open. The public route must not display bank-account data or infer that both tracks used the same account.

## Located communications chronology - summaries only

- **9 May 2012:** Garrigues requested payment of a EUR 9,450 invoice for a challenge-of-resolutions/interim-measures matter.
- **17 May 2012:** Gil stated that HAVAVIDA T&T, S.L. transferred EUR 9,450 to Garrigues and described the funding/return arrangement.
- **10 June 2013:** the earlier HAVAVIDA/Garrigues exchange was forwarded to Parrilla; a bank copy was said to have been sent separately.
- **24 November 2013:** Gil wrote a detailed history of the Garrigues engagement, dispute and wish for an amicable resolution.
- **9 December 2013:** follow-up on that proposed resolution.
- **19 February 2014:** Gil sent the judgment and requested a meeting; a Garrigues recipient replied that the earlier escalation had not reached him and that he would review the files.
- **20 February 2014:** acknowledgement/follow-up.
- **28-30 May 2020:** client-side reconciliation states the La Laguna case was budgeted at EUR 2,500, EUR 1,250 was paid initially and EUR 1,250 followed; Patricia recorded that Parrilla would retain the costs and apply them to an unpaid balance.
- **11-12 June 2020:** Parrilla's own reconciliation says Gil and Patricia paid EUR 1,250 in the La Laguna Garrigues proceeding and that, after winning with costs, a EUR 1,250 amount was applied to the insolvency proceeding.

These summaries preserve the evidential propositions without publishing full private communications. They do not establish bank settlement, privilege waiver or acceptance of every participant's characterisation.

## Open production list

1. Certified court-file index for PO 344/2013.
2. Filed claim, annex index and every annex.
3. Filed defence, annex index and every annex.
4. Preliminary-hearing act/recording, trial act/recording and final witness evidence.
5. Service, appeal and finality records.
6. Costs assessment, approval, collection and application records.
...
The public repository may carry the redacted judgment transcription, structured facts, source status, payment separation, analytical limits and open production list. It must not carry raw email bodies, Gmail identifiers, bank-account data, signatures, unnecessary personal identifiers, privileged advice, private fee ledgers or the unredacted native judgment solely for convenience.
