...
Read `archive/INSTITUTIONAL_ACCOUNTABILITY_UX_AUDIT_15AUG2026.md`, then inspect current `main` and the live ES/EN institutional/accountability pages. Audit CGPJ first, then Ministerio Fiscal, DP 1901, judge, LAJ, AC, AP4, Acosta Matos, RICPE, CNMV, Yaiza, Cabildo/Turismo, Intervención, SNCA/Fondos UE and any newly activated institutional tracks. For each score: immediate comprehension, institutional literacy, documentary credibility, fairness, visual memorability, evidential traceability, legal discipline, difficulty of rebuttal and navigation. Look specifically for strong evidence buried in prose, contradictions not visualised, unclear competence, missing remedy, absent strongest defence, missing consequence chain, receipt being confused with examination, and cross-institution convergence that can be shown without implying coordination. Preserve the common visual grammar `RECEIVED → EXAMINED → VERIFIED → DECIDED → ACTION` and the statuses DOCUMENTED / ALLEGED / INFERENCE / OPEN / CORRECTED. Implement safe high-impact improvements via branch→PR→merge→Pages verification; do not strengthen a substantive allegation merely to improve visual impact.
