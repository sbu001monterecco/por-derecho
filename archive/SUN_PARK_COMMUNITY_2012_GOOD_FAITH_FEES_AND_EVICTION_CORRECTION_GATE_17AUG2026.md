# SUN PARK — 2012 INCOMING-OPERATOR GOOD-FAITH FEES / EVICTION CORRECTION GATE
...
This is a **correction and admission**, not a deletion instruction. Do not suppress the invoices, correspondence or accounting if located. Preserve them, classify them accurately, and explain the context and the later correction.

## 2. Mandatory distinction — the 2012 mistake is not a precedent validating later Community-organ authority

Future threads must not reason:

> `Gil / incoming operator invoiced Community-type fees in 2012, therefore the later disputed Community organ, administrator, debt certificates, vote exclusions or authority claims were valid.`

That inference is prohibited unless a competent source independently establishes the relevant legal authority.

The Project position is instead:

1. the incoming management side temporarily used an incorrect fee/invoicing mechanism;
2. the reason given by the user was an operational cost anomaly: owners outside the common hotel exploitation were nevertheless consuming water, electricity, occupation/access and other infrastructure without contributing on the same basis as participating units;
3. the user accepts responsibility for the incorrect charging approach and does not seek to convert it into a lawful Community-governance precedent;
4. the existence of those invoices may show what the incoming operators believed or attempted at the time, but **does not by itself establish valid Community authority, valid debt, valid vote exclusion, valid office-holding, or a lawful later capture/continuity of the Community organ**;
5. equally, the Project must not use the later correction to pretend the invoices never existed or that every operational concern behind them was imaginary. The legal mechanism and the underlying cost/non-payment problem are separate propositions.

## 3. Evidential status of the correction
...
### 3.2 Early Community / maintenance-type invoices

**PARTY ADMISSION + PRIMARY-SOURCE RETRIEVAL TARGET:** the user confirms that the incoming operating side issued Community / maintenance-type invoices to certain non-participating owners in the first years after arrival and now says that approach was incorrect.

The native invoices, ledgers, emails, owner responses, accounting treatment and legal basis should be recovered and indexed if not already controlled. Until then, the existence and purpose of the practice are supported here by the user’s admission, not by a completed invoice-by-invoice evidential audit.

### 3.3 Operational rationale

**PARTY EXPLANATION / EVIDENCE-BASED RETRIEVAL HYPOTHESIS:** the user explains that the invoices arose because some owners had removed apartments from the common hotel exploitation while people continued to occupy/use those units and consume electricity, water and other hotel/common services without paying corresponding operating costs.

Future research should test that explanation against meter data, utility bills, hotel accounts, unit occupation records, owner correspondence, CEXP/Community accounts, maintenance records and the governing contracts/statutes.
...
Gil also recalls that **Garrigues** recommended the Monterecco route, says he considered that advice wrong very soon, and now advances **total** *ab initio* nullity of the 6-Feb LPB–Monterecco contract as his primary position because only a competent collective act could confer CEXP's owners-derived whole-hotel mandate. Declaration 009 supersedes his earlier total/partial alternative. This remains his recollection/legal position; the first presently verified Garrigues activity is 28-Mar-2012, after the 1/6-Feb instruments, and the record has not adjudicated nullity or CEXP exclusivity. Preserve the contrary 1-Feb notice, LPB-own-rights/severability case, real operation and adverse rulings. Gil authorises naming Garrigues and requests its testimony/file; this does not itself prove the advice or permit indiscriminate publication of confidential/privileged source bodies.
...
Read this section with `archive/CALIFICACION_FISCALIA_2012_2019_2026_SOURCE_BUNDLE_RETRIEVAL_GATE_16AUG2026.md` and the exact binary `CF-09` identified there.

The current repository controls the following narrow proposition from the **23-Feb-2012 pleading in Juzgado de Primera Instancia nº 4 de Arrecife, Juicio Verbal 1260/2011**:

- minority-owner litigation concerning eviction/operator use was already active before LPB entered Concurso 36/2012;
- the pleading states that the existing eviction action was against the then operating entity;
- after the claimants learned of a change in exploitation, the claim was expanded against **Monterecco Sun Park, S.L.**;
- a hearing was sought for 6 March 2012.

**Do not overstate this source.** It proves the existence and chronology of the litigation and operator-change controversy. It does **not**, by itself, prove the merits of the eviction claim, that the operator was unlawfully using apartments, that the hotel was legally residential rather than touristic, that the claimant owners’ factual characterisation was correct, or the final outcome of JV 1260/2011.

### Pink continuity control

Do not say that the 23-Feb-2012 pleading itself named `Pink Canary Services, S.L.`. The controlled corporate-continuity position in `CR-032` is that **Monterecco Sun Park, S.L. and Pink Canary Services, S.L. are the same Spanish company (NIF B76564517), with the later name change in 2013**. Therefore later references to Pink can be connected to the same legal entity, but the historical name used by the contemporaneous 2012 source must be preserved.

## 5. The pre-existing dispute must not be rewritten as something created by the 2012 incoming operators

The Project’s controlled narrative remains that the relevant ownership / exploitation / Community conflict **predated the incoming management team and the June-2012 concurso**.

The master storyline currently records:

- a 262-unit hotel/product structure (source-derived from the controlled Annex; exact title schedule remains a primary-source retrieval issue);
- a 2008–2012 split between participating and dissident / non-participating owners;
...
- preserve **approximately 23%** as the Project’s current asserted figure and an urgent verification/reconciliation target;
- do **not** convert the percentage into an exact number of fincas without the controlling title / sale / accession schedule;
...
## 7. Core anti-instrumentalisation rule for future searches

Whenever an adverse pleading, Community minute, AC report, Fiscal position, judgment, owner statement or later actor relies on early invoices issued by the incoming operator, future threads must ask all of the following:

1. What exact invoice / ledger / communication is being relied on?
2. Who issued it, in what capacity and on what stated legal basis?
3. Was the issuer purporting to act as hotel operator, CEXP, Comunidad, owner, administrator or something else?
4. What services / costs were actually being recovered?
5. Which unit / owner was charged and what was the participation status at that date?
6. Did the invoice purport to create Community voting debt, or was it an operating-cost recovery mechanism?
7. Was the invoice challenged, paid, credited, reversed or litigated?
8. What did the incoming operators later learn that caused them to abandon/correct the approach?
9. Is a later actor using the invoice merely as evidence of historical practice, or improperly treating it as legal validation of a later authority structure?
10. What independent statute, contract, acta, title, court decision or other legal source establishes the later actor’s authority regardless of the 2012 invoice?

The burden of proving a later Community organ’s legitimacy does **not** disappear because an earlier incoming operator made the same or a superficially similar charging error.

## 8. Public-facing wording control

Where this issue becomes public, use a formulation equivalent to:

> In the first period after the incoming management team arrived in 2012, it issued Community/maintenance-type charges to some owners outside the common hotel exploitation. The Project now accepts that this was an incorrect mechanism and should not have been used. The practical dispute over owners consuming hotel/common services without contributing to the operating cost base is a separate question. Those early invoices cannot, without an independent legal basis, be treated as validating the later contested authority, debt certificates, voting exclusions or governance acts of the Community organ.

Do not write:

- `we were always right about every Community charge`;
- `the invoices prove the minority owners owed lawful Community debt`;
- `because we did it, later Community actors were entitled to do it`;
- `because our invoice method was wrong, the underlying service/non-payment problem did not exist`;
- `the eviction was fraudulent` as an established fact merely from the 2012 pleading;
- `the court held Sun Park was residential apartments` unless an actual judgment/order says that and the exact proposition is quoted/contextualised.

If the Project alleges that minority owners obtained an eviction under a false residential/apartment premise or by withholding the hotel-exploitation context, classify that as **PARTY ALLEGATION** until the claim, evidence filed, hearing record and judgment/order are reviewed together.

## 9. Relationship to the authority-lineage gate

This correction is subordinate to stronger primary evidence but **mandatory alongside**:
...
## 10. Evidence retrieval targets created / sharpened by this correction

Update the existing Community predecessor-apparatus evidence queue rather than creating a duplicate. Prioritise:
