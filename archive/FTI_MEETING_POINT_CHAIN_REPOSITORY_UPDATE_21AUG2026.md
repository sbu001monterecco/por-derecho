# FTI / Meeting Point chain — repository update

**Date:** 21 August 2026  
**Status:** controlled implementation/update record  
**Repository:** `sbu001monterecco/por-derecho`

## Purpose

Record the repository-level implementation state for the standalone FTI / Meeting Point chain published through PR #751 and preserve the remaining finite evidence/document-production questions without overstating what the current record proves.
...
- Spanish standalone chain: `/es/fti-touristik-meeting-point-insolvencia-preconcurso-bluesea/`
- English standalone chain: `/en/fti-touristik-meeting-point-insolvency-preinsolvency-bluesea/`
- Spanish commercial predecessor dossier: `/es/lava-verde-club-sei-meeting-point/`
- English commercial predecessor dossier: `/en/lava-verde-club-sei-meeting-point/`
- Spanish 357/2024 traceability dossier: `/es/cuaderno-juridico/meeting-point-357-2024-trazabilidad-judicial/`
- English 357/2024 traceability dossier: `/en/legal-notebook/meeting-point-357-2024-judicial-traceability/`
- Spanish material-control dossier: `/es/toma-control-sun-park-7-junio-2018/`
- English material-control dossier: `/en/sun-park-takeover-7-june-2018/`

## Finite evidence-production queue

The remaining high-value targets are:

- exact CAM / Sun Park ↔ Meeting Point / FTI contract, proposal, term sheet, mandate or side letter;
- room/unit/finca inventory used for Club Sei Lanzarote distribution;
- PMS / CRS / channel-manager records, allotments, availability, bookings, cancellations and OTA/tour-operator feeds;
- commercial approvals, renders, pricing, product loading instructions and responsible personnel;
- invoices, commissions, settlement records, ledgers and bank receipts;
...
A dedicated `sitemap-meeting-point.xml` is added and declared in `robots.txt` so the new standalone chain and the principal predecessor/follow-on routes are explicitly indexable as one subject family.
