...
- repository regression validation and exact-marker public-edge verification;
...
## 5. Independent public-edge verification closure
...
The workflow then published the durable success status:

- context: `pages-propagation/san-telmo-attribution`;
- state: `success`;
- description: `San Telmo attribution and dossier verified live`;
- target run: `https://github.com/sbu001monterecco/por-derecho/actions/runs/32313398051`.

## 6. Canonical public routes
...
All material attribution decisions, evidential boundaries, implementation choices, public routes, validation controls, merge identities and live-verification evidence now exist outside this chat thread in the repository and public website.
