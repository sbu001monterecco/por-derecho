...
1. **15th quarterly liquidation report + AC report denominator.** Later primary reports repeatedly point to the 15th report as the liquidation-completion source. Locate that report first, then build a complete ordinal/date/registration/LAJ-receipt/annex matrix. This directly narrows both `AC-REPORT-SERIES` and `FINAL-STAGE`.
