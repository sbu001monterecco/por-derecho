...
- **Repository baseline:** `main` resolved at `5f53e58c28a22f5aab7280c82a31b34fb940f5d1`
...
| `AC-REPORT-SERIES` | `PARTIAL_FAMILY_LOCATED` | Primary/controlled material now includes the 20 September 2018 report; located 4th and 6th report copies; 25 October 2021 report / 7425/2021; primary **25 January 2022** report; primary **25 April 2022** report with a same-date liquidation-operations list/annex and LAJ/court receipt chain recording filing **3016/2022** on 28 April 2022; LAJ receipt of 5367/2022 on 27 July 2022; later quarterly-report families in November 2022, March/June/September 2023, January/September 2024 and November 2025. | Build ordinal/date/registration/receipt/annex matrix; locate the **15th quarterly liquidation report**; pair the underlying July 2022 report to filing 5367/2022; recover every missing report/annex; reconcile ledger/bank movements; then final accounts. | **P0-1** |
...
1. **15th quarterly liquidation report + AC report denominator.** Later primary reports repeatedly point to the 15th report as the liquidation-completion source. Locate that report first, then build a complete ordinal/date/registration/LAJ-receipt/annex matrix. The newly located January and April 2022 anchors make the 2022 sequence materially tighter without proving any report ordinal. This directly narrows both `AC-REPORT-SERIES` and `FINAL-STAGE`.
...
`ordinal_if_known | report_date | filing_registration | LAJ_receipt_date | report_primary | annexes | service/transfer | challenge | decision | finality | source_hash | canonical_path | notes`
...
- 27 July 2022 — LAJ receipt of filing 5367/2022 located; underlying 5367 report remains to be paired to that receipt.
...
> Nine P0 evidence families remain open. Primary-source recovery has materially narrowed several of them: the October 2021 chain, the AC-report series and the 2022–2023 review family now contain located primary nodes, while current appeals have located procedural nodes but no merits endpoint yet located. No family is treated as closed until its pre-existing closure test is satisfied.
...
**Locate and authenticate the 15th quarterly liquidation report.**

That report is presently the strongest single recovery target because later primary AC reports repeatedly identify it as the operative description of completed asset liquidation. Its recovery can materially narrow two P0 families at once and define the exact final-accounting/conclusion delta.
