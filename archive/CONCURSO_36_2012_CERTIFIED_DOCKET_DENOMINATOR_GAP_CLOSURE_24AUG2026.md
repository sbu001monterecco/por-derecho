# Concurso 36/2012 — certified-docket denominator gap closure

**Run date:** 24 August 2026  
**Status:** controlled source refresh; draft branch; not merged or deployed
...
- Twelve bounded Drive searches covering `índice de autos`, certified chronology, full file, testimonios, LAJ acts, sections/piezas, liquidation closure and rendición de cuentas.
- Four bounded Gmail/LexNET searches covering official 36/2012 notification/transfer families, the Article 75 report and the conclusion application.
- Exact Drive searches for the three 15-Aug-2026 institutional registration receipts.

A no-result search is a retrieval gap, not proof of non-existence.
...
5. **Existing 65-node baseline:** remains the controlled 2016–2021 item-level digest. The refresh proves it is not the whole-file denominator and must be reconciled package-by-package before its item count is expanded.

## Bidirectional completeness test
...
The 2013 report supplies a sharper and fairer line of criticism than generalized accusations:

- it simultaneously characterizes documentary cooperation as not acceptable and records attendance at every requested meeting, cordial/fluid relations and cooperative disposition;
- it provisionally placed assets at EUR 16.75m against EUR 9.47m of insolvency liabilities, while acknowledging verification limits; and
- it announced asset-protection, recovery and possible rescission/criminal steps whose authorization, execution and results must be traced.

This supports a demand for explanations about value preservation, income, action/inaction and causal transition. It does not establish criminality, improper judicial assistance or a final solvency finding.
...
8. external criminal/civil/administrative proceedings kept outside the Mercantile count unless formally incorporated.

## Publication decision

Publish the limitation, the mixed Article 75 evidence, the bounded package counts and the exact acquisition asks. Do not publish private originals, raw email bodies, personal identifiers, addresses, account data, signatures, verification codes or unreviewed annexes. An allegation must remain attributed; an adverse holding must appear beside the criticism; an apparent contradiction remains open until its source chain is complete.
