...
|---|---|---|---|---|---|
| `ME-MAIL-RDM-001` | exportación nativa completa y autorizada de `RDM-PRIVATE-MAILBOX-01`, perfiles/etiquetas, manifiesto, hashes y reconciliación | denominador completo, autenticación, mensajes ausentes de la copia conectada, adjuntos, borrados/etiquetas y procedencia | más de 2.400 mensajes relacionados localizados en una búsqueda definida del lado conectado; a las 22:49 UTC del 25-ago-2026 Gil comunicó que la titular ejecutaba una recopilación autorizada en su ChatGPT con Gmail conectado y preveía un posible traslado privado dentro de aproximadamente una hora; recepción, Drive, exportación nativa, denominador y reconciliación todavía no verificados | verificar el traslado con `RDM_PRIVATE_MAILBOX_PENDING_INBOUND_CONTROL_25AUG2026.md` y ejecutar el prompt de ingesta; completar Takeout y, si procede, API RAW; reconciliar mensajes/hilos/adjuntos/errores y aplicar privilegio | **PARCIAL / CRÍTICA — RECOPILACIÓN COMUNICADA EN CURSO; RECEPCIÓN NO VERIFICADA** |
