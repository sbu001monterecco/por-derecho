# Project Sun Rock / Por Derecho — Canonical Outbound Source-Kit Manifest

**Control date:** 23 August 2026  
**Status:** canonical internal outbound-source manifest  
**Purpose:** eliminate attachment/link drift and make future audience-specific outreach reproducible  
...
## Controlled audiovisual source

### San Telmo / RICPE webinar — 30 November 2021

- Public source: `https://www.youtube.com/watch?v=mHn9IJU0qI4&t=488s`
- Controlled first-look timestamp: approximately **08:08–08:12**.
- Current speaker attribution: **Eduardo Sánchez Iglesias**.
- Relevant statement: he explains that “el despacho” introduced several clients into the first investment.
- Evidential use: supports finite questions about investor origin/introduction, professional knowledge, advisory role, due diligence, separation of functions and project controls.
- Mandatory limitation: the statement does **not** by itself prove irregularity, improper conduct, defective advice, collusion or unlawful investment.
...
| RIC / RICPE / incentives / source-and-use | current funding/investment routes | Never imply public finance or RIC investment itself proves wrongdoing |
...
Before final approval verify every outbound link for:

- exact destination;
- live resolution;
- language;
- current correction state;
- relevance to the recipient’s first question; and
- whether the linked page itself distinguishes verified fact, allegation, inference and open question.
