...
> Canarian Hospitality lanza su primera marca y anuncia 12 hoteles

That article reported a planned 2022 Playa Blanca opening and stated that Canarian Hospitality had the strategic and financial support of Grupo Acosta Matos.

The article is used as a **market-information timestamp**, not as evidence that Taiana or HOSTELTUR knew the internal RICPE title position.
...
→ `CAM creditor + specific-property entry / 54-CAM provenance`
→ `2018 material-control transition / adverse dismissal retained`
→ `pre-title Lava Verde / pilot / Club Sei / Meeting Point market preparation`
→ `2020 integrated project/ownership representation`
→ `July-2021 internal 54 CAM / 190 LPB / 18 terceros + conditional title + unsigned LOI + incomplete DD`
→ `15-Oct-2021 HOSTELTUR / Canarian Hospitality / Playa Blanca market narrative`
→ `2022–2023 HNT / MYND / RIC / incentives / EU-cofinancing and subsequent HOSTELTUR transformation coverage`
→ `2026 constructive Yaiza + Cabildo resolution route`.

## 3. HOSTELTUR-specific commercial bridge

The package expressly adds the pre-title tourism/distribution chain preserved in:

`/es/lava-verde-club-sei-meeting-point/`

The narrow controlled propositions are:

- Lava Verde was publicly presented at C/ Janubio 3 as a 279-room CAM project;
- Meeting Point Hotels/FTI publicly announced Club Sei Lanzarote;
- an archived February-2020 commercial listing offered Club Sei Lanzarote in Playa Blanca;
- a direct supplier communication linked Sun Park to the establishment it knew as Lava Verde and recorded a pilot-room installation before the 2022 LPB adjudication.

The package does **not** claim that an unlawful Meeting Point contract has been proved, that all 279 rooms were legally available, that bookings/revenue occurred, or that a particular Meeting Point legal person has already been established as contracting party.

The resulting tourism-industry question is:

`279-room project / commercial preparation → which rooms/properties/authority? → July-2021 54 CAM / 190 LPB / 18 terceros → what exactly was represented to hotel-market journalists, investors, operators and distributors?`
...
- the November-2023 HOSTELTUR RIC-project description of the transformation of the former Sun Park into MYND Yaiza.

It asks what non-confidential dossier, presentation, communication or other source supported those descriptions and what, if anything, was independently verified about:

- property perimeter;
- project/site availability;
- control;
- operating authority; and
- timing of acquisition/title.
...
- the 54-CAM provenance/minority route;
- the 7-Jun-2018 dossier;
- the Lava Verde / Club Sei / Meeting Point dossier;
- the HOSTELTUR-specific traceability route;
- the RICPE→HNT→GC/836/P06 / European-support route;
