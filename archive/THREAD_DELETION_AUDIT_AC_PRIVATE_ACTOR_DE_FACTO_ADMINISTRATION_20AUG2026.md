...
1. Functional private management of Community debt, voting, access, security and maintenance is source-supported.
2. AC request, attendance, identified access authorisations and reliance on creditor-generated debt material are source-supported.
...
- private email bodies and message IDs;
- unredacted court records;
- unnecessary personal identifiers;
- privileged legal advice;
- confidential prosecutorial strategy beyond the separately delivered memorandum.

A future thread must re-query connected Gmail, Drive, Files and the certified court record for native evidence.
