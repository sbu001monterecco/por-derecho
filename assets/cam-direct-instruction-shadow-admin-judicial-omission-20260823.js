...
(() => {
  ...
  const render = () => {
    ...
    const c = en ? {
      ...
      lead: 'Gil Marer and Aweswell directly allege that five identified private actors operated, by 2018 at the latest, as a coordinated de facto or shadow-administration structure over Luchy Playa Blanca’s patrimonial and business sphere and the integrated hotel platform, through conduct inside the formal insolvency and outside its recorded perimeter; that the insolvency administrator criminally enabled the structure by affirmative acts as well as omissions; and that Magistrate-Judge Alberto López Villarrubia preserved it through specified decisions, refusals, delay and omissions, thereby allegedly sabotaging or frustrating a developed, finance-backed exit. These are the controlling direct criminal allegations—not merely questions, and not adjudicated findings.',
      ...
      judgeP: 'Gil alega directamente que resoluciones, negativas, cierres probatorios, demoras y omisiones concretas del Magistrado-Juez D. Alberto López Villarrubia preservaron conscientemente el control privado y sabotearon o frustraron una salida desarrollada, multivía y respaldada por financiación. Gil califica la secuencia como prevaricación judicial consciente en las modalidades jurídicamente aplicables; es una alegación directa, no una conclusión judicial. El informe Irigoyen de 13 de junio de 2018 sustenta una reunión directa con el juez; otras visitas siguen sin probarse. Cada acto exige prueba entonces ante el juez, competencia y deber, injusticia objetiva o demora maliciosa, conocimiento, finalidad y causalidad.',
