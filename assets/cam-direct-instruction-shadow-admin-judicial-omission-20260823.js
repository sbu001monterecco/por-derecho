...
(() => {
  ...
  const render = () => {
    ...
    const c = en ? {
      ...
      identityT: 'Identity control — Laura Isabel is not silently replaced by Laura Patricia',
      identityP: 'The 7 June complaint amendment names Laura Isabel Acosta Matos; the repository’s LPAM convention identifies Laura Patricia Acosta Matos. Gil attributes responsibility to LPAM, but the public record keeps the identity/participation bridge open until primary evidence connects the names or establishes separate involvement.',
      ...
      identityT: 'Control de identidad — Laura Isabel no se sustituye silenciosamente por Laura Patricia',
      identityP: 'La ampliación de denuncia de 7 de junio nombra a Laura Isabel Acosta Matos; la convención LPAM del repositorio identifica a Laura Patricia Acosta Matos. Gil atribuye responsabilidad a LPAM, pero el registro público mantiene abierto el puente de identidad/participación hasta que prueba primaria conecte los nombres o acredite participación separada.',
