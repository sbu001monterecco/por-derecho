(() => {
  ...
  const t = isEN ? {
    ...
    audience: '<strong>Who this is for:</strong> hotel/property principals, sophisticated family capital, private-wealth and corporate-banking teams, hotel-finance/private-credit and institutional counterparties able to assess either a long-term relationship or a specific ring-fenced asset. This public page is informational only: there is no public investment route, retail subscription or representation of committed financing.',
    conversationKicker: 'Institutional relationship',
    conversationTitle: 'Start with architecture, not a product pitch.',
    conversationText: 'A first conversation can test fit across three separate lanes: family/private wealth, Aweswell/Sun Rock corporate banking, or an individual ProjectCo. Each lane remains independently governed and underwritten; no financing, mandate or investment is implied until it is separately agreed and documented.',
    relationshipButton: 'Strategic financial relationship',
    scaleButton: 'Platform scale'
  } : {
    ...
    audience: '<strong>A quién se dirige:</strong> a empresarios hoteleros o inmobiliarios, capital familiar sofisticado, equipos de banca privada y corporativa, financiación hotelera/crédito privado y contrapartes institucionales capaces de evaluar una relación de largo plazo o un activo segregado concreto. Esta página pública es meramente informativa: no existe vía pública de inversión, suscripción minorista ni afirmación de financiación comprometida.',
    conversationKicker: 'Relación institucional',
    conversationTitle: 'Empezar por la arquitectura, no por presentar un producto.',
    conversationText: 'Una primera conversación puede comprobar el encaje en tres vías separadas: patrimonio privado/familiar, banca corporativa de Aweswell/Sun Rock o una ProjectCo individual. Cada vía conserva gobierno y análisis propios; no se implica financiación, mandato o inversión hasta que se acuerde y documente por separado.',
    relationshipButton: 'Relación financiera estratégica',
    scaleButton: 'Escala de plataforma'
  };
  ...
  style.textContent = `
    ...
    .pd-home-future-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;background:rgba(13,47,56,.12)}
    .pd-home-future-card{background:#fff;padding:1.2rem;display:flex;flex-direction:column;min-height:310px}
    .pd-home-future-card .tag{font-size:.7rem;font-weight:900;letter-spacing:.08em;color:#8a6330;text-transform:uppercase}
    .pd-home-future-card h4{font-size:1.25rem;line-height:1.2;color:#132f38;margin:.45rem 0 .65rem}
    .pd-home-future-card p{color:#4a5d63;line-height:1.58;font-size:.92rem;margin:0 0 1rem}
    ...
    @media(max-width:900px){.pd-home-future-grid{grid-template-columns:1fr}.pd-home-future-card{min-height:0}}
  `;
  ...
  if (conversation) {
    conversation.innerHTML = `
      ...
      <div class="actions"><a class="button" href="${routes.relationship}">${t.relationshipButton}</a><a class="button secondary" href="${routes.scale}">${t.scaleButton}</a></div>`;
  }
})();
