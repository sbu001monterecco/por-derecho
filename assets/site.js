(() => {
  ...
  const loadMasterProceedingsPublication = () => {
    ...
    proceedings.src = new URL('master-proceedings-publication-20260830.js?v=20260830b', current.src).href;
    proceedings.async = false;
    proceedings.setAttribute('data-master-proceedings-publication-loader', '20260830b');
