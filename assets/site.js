(() => {
  ...
  // Preserves ONA↔Clubotel entity separation, conditionality and the actor-specific causation boundary.
  load('calificacion-documentary-counter-record-20260816.js?v=20260816d');
