(() => {
  ...
  const patchRicpePreFiling = () => {
    ...
    const section = make(en
      ? '<section class="section alt" id="formal-communication-17aug" data-ricpe-prefiling-status><div class="shell"><p class="eyebrow">FORMAL COMMUNICATION STATUS · 17 AUGUST 2026</p><h2>Reviewed Final V6 prepared for digital signature and submission to RICPE.</h2><p>Gil Marer, writing from San Cristóbal de La Laguna, has completed a reviewed 21-page formal communication addressed exclusively to RICPE. It is intended to be digitally signed and submitted through the RICPE Ethical Channel and by corporate email on 17 August 2026. Final V5 was superseded before filing.</p><p class="warn"><strong>Current controlled status:</strong> the reviewed Final V6 is prepared, but at the time of this update no Ethical Channel receipt, case code, signed-file hash or corporate-email transmission record has been recorded. It is therefore not described as filed, received, admitted or examined.</p><p><strong>Status grammar:</strong> prepared ≠ signed ≠ filed ≠ received ≠ admitted ≠ examined ≠ decided. After filing, this record will be updated with the public-safe reference, signed PDF SHA-256 and each later CNMV or other-authority transmission as a separate institutional event. The full binary and access credentials are not published at this stage.</p></div></section>'
      : '<section class="section alt" id="comunicacion-formal-17ago" data-ricpe-prefiling-status><div class="shell"><p class="eyebrow">ESTADO DE LA COMUNICACIÓN FORMAL · 17 AGOSTO 2026</p><h2>V6 final revisada y preparada para firma electrónica y presentación ante RICPE.</h2><p>Gil Marer, desde San Cristóbal de La Laguna, ha completado una comunicación formal revisada de 21 páginas dirigida exclusivamente a RICPE. Está prevista su firma electrónica y presentación por el Canal Ético de RICPE y por correo corporativo el 17 de agosto de 2026. La V5 quedó sustituida antes de su presentación.</p><p class="warn"><strong>Estado controlado actual:</strong> la V6 final revisada está preparada, pero en el momento de esta actualización no consta todavía justificante del Canal Ético, código de expediente, hash del PDF firmado ni registro de envío por correo corporativo. Por ello no se describe como presentada, recibida, admitida o examinada.</p><p><strong>Gramática de estado:</strong> preparado ≠ firmado ≠ presentado ≠ recibido ≠ admitido ≠ examinado ≠ decidido. Tras la presentación, este registro se actualizará con la referencia pública segura, el SHA-256 del PDF firmado y cada remisión posterior a CNMV u otra autoridad como evento institucional separado. En esta fase no se publica el binario completo ni credenciales de acceso.</p></div></section>');
  ...
  const patchUpdates = () => {
    ...
    if (!document.querySelector('#ricpe-formal-prefiling-17aug')) {
      const prefiling = make(en
        ? '<section class="updates-section" data-ricpe-prefiling-update><div class="shell"><section class="date-group"><h2>17 August 2026 · RICPE</h2><div class="update-stream"><article class="material-update institutional" id="ricpe-formal-prefiling-17aug"><div class="update-meta"><span class="new">Reviewed V6</span><span>Pending signature</span><span>Pending filing</span></div><h3>Reviewed Final V6 formal communication prepared for controlled submission to RICPE</h3><p>Gil Marer, writing from San Cristóbal de La Laguna, has completed a reviewed 21-page communication addressed exclusively to RICPE for digital signature and submission through the Ethical Channel and corporate email on 17 August 2026. Final V5 was superseded before filing.</p><p><strong>Evidence boundary:</strong> no filing receipt or signed-file hash has yet been recorded, so this update does not say the communication has been filed, received, admitted or examined. After filing, the record will add the public-safe reference, signed-file SHA-256 and any later CNMV or other-authority transmission separately.</p><div class="update-actions"><a class="button" href="../ricpe-documentary-accountability/#formal-communication-17aug">Current RICPE status →</a></div></article></div></section></div></section>'
        : '<section class="updates-section" data-ricpe-prefiling-update><div class="shell"><section class="date-group"><h2>17 agosto 2026 · RICPE</h2><div class="update-stream"><article class="material-update institutional" id="ricpe-formal-prefiling-17aug"><div class="update-meta"><span class="new">V6 revisada</span><span>Pendiente de firma</span><span>Pendiente de presentación</span></div><h3>Comunicación formal V6 final revisada y preparada para presentación controlada ante RICPE</h3><p>Gil Marer, desde San Cristóbal de La Laguna, ha completado una comunicación revisada de 21 páginas dirigida exclusivamente a RICPE para firma electrónica y presentación por el Canal Ético y correo corporativo el 17 de agosto de 2026. La V5 quedó sustituida antes de su presentación.</p><p><strong>Límite probatorio:</strong> todavía no se ha registrado justificante de presentación ni hash del archivo firmado, por lo que esta actualización no afirma que la comunicación haya sido presentada, recibida, admitida o examinada. Tras la presentación se añadirán la referencia pública segura, el SHA-256 del PDF firmado y cada remisión posterior a CNMV u otra autoridad por separado.</p><div class="update-actions"><a class="button" href="../ricpe-responsabilidad-documental/#comunicacion-formal-17ago">Estado actual RICPE →</a></div></article></div></section></div></section>');
