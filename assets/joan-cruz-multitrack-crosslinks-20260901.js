(() => {
  ...
  const routes = [
    '/es/cadena-evidencia-joan-cruz-sun-park/','/en/joan-cruz-sun-park-evidence-chain/',
  ...
  const evidenceChain = isEn ? `${base}en/joan-cruz-sun-park-evidence-chain/` : `${base}es/cadena-evidencia-joan-cruz-sun-park/`;
