(() => {
  ...
  item.innerHTML = isEnglish
    ? `
      <h3>30 September 2013 — Spanish company: same NIF, new name</h3>
      ...
      <p class="source-policy"><strong>Do not confuse the two name changes:</strong> UK <em>Monterecco Sun Park Limited → Aweswell Limited</em>, company no. 07716847; Spain <em>Monterecco Sun Park, S.L. → Pink Canary Services, S.L.</em>, NIF B76564517. Official Spanish background: <a href="https://www.boe.es/diario_borme/txt.php?id=BORME-A-2012-110-38" rel="external noopener">BORME — Monterecco Sun Park, sheet H TF 49739</a>. The later-name continuity is supported by the signed company book and Sentencia 163/2023 in the controlled record.</p>`
    : `
      <h3>30 de septiembre de 2013 — sociedad española: mismo NIF, nueva denominación</h3>
      ...
      <p class="source-policy"><strong>No confundir los dos cambios de denominación:</strong> Reino Unido <em>Monterecco Sun Park Limited → Aweswell Limited</em>, sociedad nº 07716847; España <em>Monterecco Sun Park, S.L. → Pink Canary Services, S.L.</em>, NIF B76564517. Contexto oficial español: <a href="https://www.boe.es/diario_borme/txt.php?id=BORME-A-2012-110-38" rel="external noopener">BORME — Monterecco Sun Park, hoja H TF 49739</a>. La continuidad de la denominación posterior se apoya en el libro societario firmado y la Sentencia 163/2023 del expediente controlado.</p>`;
