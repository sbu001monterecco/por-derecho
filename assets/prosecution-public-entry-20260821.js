    ...
    section.innerHTML = isEn ? `
      <div class="shell">
        ...
        <div class="pe-grid">
          ...
          <article class="pe-card"><b>2 · insolvency administrator</b><strong>Affirmative criminal enablement and legally equivalent omission alleged</strong><span>The authority route, emails, meetings, authorisations, adoption, ratification, supervision, power to restore or reverse, intent and causation must be tested against the denial and narrower-access account.</span></article>
          <article class="pe-card"><b>3 · finance / judicial conduct</b><strong>Destruction or obstruction of the security package and exit alleged</strong><span>Gil says Aweswell could perform its side while collateral, debt certification, authority and asset access depended on the adverse/AC/court chain. ONA was signed; the supplied Ben Oldman copy is borrower-side signed with the lender line blank; the Lagune/Elaia route retained blank acceptances. One 13 June judge meeting is supported; further visits are not.</span></article>
      ...
      <div class="shell">
        ...
        <div class="pe-grid">
          ...
          <article class="pe-card"><b>2 · administrador concursal</b><strong>Se alega habilitación penal afirmativa y omisión jurídicamente equivalente</strong><span>La vía de autoridad, correos, reuniones, autorizaciones, adopción, ratificación, supervisión, capacidad de restaurar o revertir, intención y causalidad deben contrastarse con la negativa y el relato de acceso limitado.</span></article>
          <article class="pe-card"><b>3 · financiación / conducta judicial</b><strong>Se alega destrucción o bloqueo del paquete de garantías y de la salida</strong><span>Gil sostiene que Aweswell podía cumplir su parte mientras colateral, certificación de deuda, autoridad y acceso al activo dependían de la cadena adversa/AC/juzgado. ONA estaba firmado; la copia Ben Oldman aportada tiene firmas del lado prestatario y línea del financiador en blanco; Lagune/Elaia conservaba aceptaciones en blanco. Se apoya una reunión judicial el 13 de junio; no otras visitas.</span></article>
