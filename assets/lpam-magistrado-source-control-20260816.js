(() => {
  ...
  section.innerHTML = isEs ? `
    <div class="shell record">
      <p class="eyebrow">CONTROL DE FUENTES · LPAM–MAGISTRADO · 17 AGO 2026</p>
      <h2>Qué está documentado, qué se ha corregido y qué todavía exige verificación oficial</h2>
      <p>La revisión conjunta de Gmail, Library/Files, Drive y los documentos judiciales permite separar las capas de este módulo. <strong>No publicamos como hecho que existiera una amistad, acceso impropio, influencia o coordinación.</strong> Publicamos qué fuentes existen y qué registro oficial puede confirmarlas, rechazarlas o limitar su alcance.</p>
      <p><strong>Control de identidad:</strong> la persona que memorializó el relato pertenece al perímetro personal y empresarial de Gil Marer y su identidad se reserva en la publicación. Es una persona distinta de <strong>Laura Patricia Acosta Matos (LPAM)</strong>, cuya identidad se mantiene íntegra por ser la persona a quien se atribuyen las manifestaciones relevantes. El otro testigo referido en ese episodio se describe públicamente como <strong>un asesor jurídico de Gil Marer en aquel momento</strong>.</p>
      <ul>
        ...
        <li><strong>5 junio 2020 · memorialización contemporánea:</strong> una persona del perímetro personal y empresarial de Gil Marer dejó por escrito afirmaciones que atribuye a <strong>Laura Patricia Acosta Matos (LPAM)</strong> sobre amistad/acceso/contacto con el Magistrado y señaló como presente a <strong>un asesor jurídico de Gil Marer en aquel momento</strong>. Esto acredita la existencia del relato a esa fecha; <strong>no acredita la verdad de la relación afirmada</strong> ni sustituye metadatos telefónicos, comunicaciones directas o una comprobación oficial.</li>
        ...
        <li><strong>Corrección testimonial:</strong> las declaraciones firmadas de 28 de julio de 2026 limitan lo observado a la salida del Magistrado, saludo y breve intercambio/cortesías. <strong>La declarante del perímetro de Gil Marer</strong> dice expresamente que no oyó el contenido de una conversación privada, no vio a LPAM a solas con el Magistrado y no la vio entrar en su despacho. La expresión anterior de Gil equivalente a <em>“conversación privada”</em> queda controlada como inferencia, no como percepción auditiva directa.</li>
    ...
    <div class="shell record">
      <p class="eyebrow">SOURCE CONTROL · LPAM–JUDGE · 17 AUG 2026</p>
      <h2>What is documented, what has been corrected, and what still requires official verification</h2>
      <p>The combined Gmail, Library/Files, Drive and court-record review separates the evidential layers of this module. <strong>We do not publish as fact that there was a friendship, improper access, influence or coordination.</strong> We publish the sources that exist and the official records capable of confirming, rejecting or narrowing them.</p>
      <p><strong>Identity control:</strong> the person who memorialised the account is within Gil Marer’s personal and business perimeter and their identity is withheld in the public record. That person is entirely distinct from <strong>Laura Patricia Acosta Matos (LPAM)</strong>, whose identity remains fully stated because the relevant remarks are attributed to her. The other witness referred to in that episode is described publicly as <strong>one of Gil Marer’s legal advisers at the relevant time</strong>.</p>
      <ul>
        ...
        <li><strong>5 June 2020 · contemporaneous memorialisation:</strong> a person within Gil Marer’s personal and business perimeter put in writing statements they attribute to <strong>Laura Patricia Acosta Matos (LPAM)</strong> concerning friendship/access/contact with the Judge and identified <strong>one of Gil Marer’s legal advisers at the relevant time</strong> as present. This proves the account existed by that date; <strong>it does not prove the asserted relationship was true</strong> and is not a substitute for telephone metadata, direct communications or official verification.</li>
