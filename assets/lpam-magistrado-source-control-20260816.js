  ...
  section.innerHTML = isEs ? `
    ...
    <div class="shell record">
      ...
      <ul>
        ...
        <li><strong>Mandatory counterevidence:</strong> the 18 May Auto 164/2021 records that Aweswell made the higher offer and that the immediate result of the hearing favoured Aweswell. That fact must remain visible against any simplistic theory of predetermination in CAM's favour.</li>
