  ...
  section.innerHTML = isEs ? `
    <div class="shell record">
      ...
      <ul>
        ...
        <li><strong>Corrección primaria obligatoria:</strong> el Auto 164/2021 de 18 de mayo recoge una propuesta de un <strong>tercer oferente</strong> por 14,8 M€, su incomparecencia y la falta de constitución de la caución; declara que, tras esos hechos, la licitación competitiva no podía tener lugar y aprueba definitivamente la propuesta de CAM. La comparecencia de licitación aclarada después no se confunde con una subasta. Este desenlace documentado no prueba por sí solo predeterminación ni regularidad integral: deben verificarse notificación, oferta presentada, poderes, fondos, caución y acta o grabación completa.</li>
    ...
    <div class="shell record">
      ...
      <ul>
        ...
        <li><strong>Mandatory primary-source correction:</strong> the 18 May Auto 164/2021 records a EUR 14.8m proposal by a <strong>third-party bidder</strong>, the bidder's nonappearance and failure to lodge the bond; it states that, after those events, the competitive licitation could not take place and definitively approves CAM's proposal. The later clarified licitation appearance is not conflated with an auction. That documented outcome does not by itself prove predetermination or complete regularity: service, the filed proposal, authority, funds, bond and the complete minute or recording still require verification.</li>
