(() => {
  ...
  const t = isEN ? {
    ...
    lanes:[
      ['DP 1901/2026','Private actors / Control 21','86-page operative complaint + 26-page 26 June amplification + 19-page 9 July amplification. Public layer indexes actors, entities, chronology, allegation types, evidence sources, requested measures, limitations and open proof.','9 July: private-actor material physically tendered under DP 1901. The 12 July providencia links that DP to DIP 2/2026; the 14 September Auto treats it as alleged judicial prevarication and orders final dismissal/archive. Original allocation and the direction of the identity collision remain uncertified.'],
      ...
      ['Control 24','Judicial decisions / supervision','79-page signed package + 13-page dependent supplement (31-page principal bundle: 4 pages front matter + 27-page pleading). Five modules: funded exit, credit/threshold, OB REM/non-validation, bidding/adjudication and legal-entity identity.','Presented 18 June 2026 under daily locator 24; post-intake allocation remains uncertified. The later DP 1901 judicial-prevarication treatment opens an identity collision; it does not certify Ref. 24 as the initiating filing or a formal joinder.']
    ],
    events:[
    ...
    lanes:[
      ['DP 1901/2026','Actores privados / Control 21','Denuncia operativa de 86 páginas + ampliación de 26 de junio de 26 páginas + ampliación de 9 de julio de 19 páginas. La capa pública indexa actores, entidades, cronología, tipos de alegación, fuentes, diligencias solicitadas, límites y prueba pendiente.','9 de julio: material de actores privados presentado físicamente bajo DP 1901. La providencia de 12 de julio vincula ese DP con DIP 2/2026; el Auto de 14 de septiembre lo trata como presunta prevaricación judicial y acuerda sobreseimiento libre/archivo. El reparto originario y la dirección de la colisión siguen sin certificarse.'],
      ...
      ['Control 24','Resoluciones / supervisión judicial','Paquete firmado de 79 páginas + aportación dependiente de 13 páginas (bloque principal de 31 páginas: 4 de presentación + 27 de escrito). Cinco módulos: salida financiada, crédito/umbral, OB REM/no convalidación, licitación/adjudicación e identidad societaria.','Presentado el 18 de junio de 2026 bajo localizador diario 24; reparto posterior sin certificar. El tratamiento posterior de DP 1901 como prevaricación judicial abre una colisión de identidad; no certifica que Ref. 24 iniciara el DP ni una acumulación formal.']
    ],
    events:[
