(() => {
  ...
  const routes = isEs ? {
    ...
    precursor: `${link('toma-control-sun-park-7-junio-2018/')}#proyecto-antes-del-titulo`,
    day: `${link('toma-control-sun-park-7-junio-2018/')}#hechos-7-junio`,
    after: `${link('toma-control-sun-park-7-junio-2018/')}#desplazamiento-y-beneficio`,
    ...
    precursor: `${link('sun-park-takeover-7-june-2018/')}#project-before-title`,
