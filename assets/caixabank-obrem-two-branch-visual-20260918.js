(() => {
  ...
  const copy = es ? {
    ...
    ruleText: 'Un resultado en Valencia puede obligar a recalcular o reexaminar la rama posterior, pero no anula automáticamente SAREB→PH122→CAM, la operación OB REM o la adjudicación. Del mismo modo, la validez o invalidez de un acto OB REM no decide por sí sola el litigio de Valencia.',
    cta1: 'Valencia',
    cta2: 'OB REM',
    ...
    rule: 'READING RULE',
    ruleText: 'A Valencia outcome may require recalculation or consequential review downstream, but it does not automatically invalidate SAREB→PH122→CAM, the OB REM transaction or the adjudication. Equally, validity or invalidity of an OB REM act does not itself decide Valencia.',
    cta1: 'Valencia',
    cta2: 'OB REM',
